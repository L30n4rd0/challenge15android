...
public class zzkt extends zzkw {
    ...
    class C03551 implements OnClickListener {
        ...
        C03551(zzkt com_google_android_gms_internal_zzkt, String str, String str2) {
    ...
    class C03562 implements OnClickListener {
        ...
        C03562(zzkt com_google_android_gms_internal_zzkt) {
            this.zzMq = com_google_android_gms_internal_zzkt;
        }
        ...
        if (this.mContext == null) {
            ...
            if (TextUtils.isEmpty(str)) {
                ...
                if (zzw.zzcM().zzaZ(zzay)) {
                    ...
                    zzM.setPositiveButton(resources != null ? resources.getString(C0156R.string.accept) : "Accept", new C03551(this, str, zzay));
                    zzM.setNegativeButton(resources != null ? resources.getString(C0156R.string.decline) : "Decline", new C03562(this));
                    zzM.create().show();
                    return;
                }
