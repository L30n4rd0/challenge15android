...
public class zzw implements zzb {
    ...
    static class zza {
        ...
        public static zza zzf(InputStream inputStream) throws IOException {
            ...
            if (com_google_android_gms_internal_zzw_zza.zza.equals(BuildConfig.FLAVOR)) {
        ...
        public boolean zza(OutputStream outputStream) {
            try {
                ...
                zzw.zza(outputStream, this.zza == null ? BuildConfig.FLAVOR : this.zza);
    ...
    public synchronized void initialize() {
        ...
        r0 = 0;
        monitor-enter(r9);
        r1 = r9.zzay;	 Catch:{ all -> 0x006a }
        r1 = r1.exists();	 Catch:{ all -> 0x006a }
        if (r1 != 0) goto L_0x0025;
    L_0x000a:
        r0 = r9.zzay;	 Catch:{ all -> 0x006a }
    ...
    L_0x0031:
        ...
        r1 = com.google.android.gms.internal.zzw.zza.zzf(r0);	 Catch:{ IOException -> 0x0076 }
        r6 = r5.length();	 Catch:{ IOException -> 0x0076 }
        r1.zzaA = r6;	 Catch:{ IOException -> 0x0076 }
        r6 = r1.zzaB;	 Catch:{ IOException -> 0x0076 }
    ...
    public synchronized com.google.android.gms.internal.zzb.zza zza(String str) {
        ...
        if (com_google_android_gms_internal_zzw_zza == null) {
            ...
            File zzf = zzf(str);
            try {
                com_google_android_gms_internal_zzw_zzb = new zzb(null);
                try {
