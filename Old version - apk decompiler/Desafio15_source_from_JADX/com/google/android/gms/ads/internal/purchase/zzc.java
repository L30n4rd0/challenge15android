...
public class zzc extends zzpj implements ServiceConnection {
    ...
    class C01781 implements Runnable {
        ...
        C01781(zzc com_google_android_gms_ads_internal_purchase_zzc, zzf com_google_android_gms_ads_internal_purchase_zzf, Intent intent) {
    ...
    private void zze(long j) {
        do {
            if (!zzf(j)) {
                zzpk.m13v("Timeout waiting for pending transaction to be processed.");
            }
        } while (!this.zzPs);
    }
    ...
    protected void zza(zzf com_google_android_gms_ads_internal_purchase_zzf, String str, String str2) {
        ...
        zzpo.zzXC.post(new C01781(this, com_google_android_gms_ads_internal_purchase_zzf, intent));
    }
