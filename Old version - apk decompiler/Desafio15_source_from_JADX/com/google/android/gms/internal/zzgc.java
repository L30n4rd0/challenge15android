...
public class zzgc {
    ...
    class C03131 implements Callable<T> {
        final /* synthetic */ zzfz zzBe;
        final /* synthetic */ zzgc zzBf;

        C03131(zzgc com_google_android_gms_internal_zzgc, zzfz com_google_android_gms_internal_zzfz) {
    ...
    public <T> T zzd(zzfz<T> com_google_android_gms_internal_zzfz_T) {
        if (this.zzBc.block(5000)) {
            ...
            return zzqb.zzb(new C03131(this, com_google_android_gms_internal_zzfz_T));
        }
