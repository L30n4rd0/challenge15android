...
public final class zzbxl {
    ...
    private zzbxl(byte[] bArr, int i, int i2) {
        this.zzcuv = ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED;
        this.zzcux = 64;
        this.zzcuy = 67108864;
        this.buffer = bArr;
        this.zzcuq = i;
    ...
    public long zzaex() throws IOException {
        ...
        for (int i = 0; i < 64; i += 7) {
            ...
            if ((zzaeD & TransportMediator.FLAG_KEY_MEDIA_NEXT) == 0) {
                return j;
            }
        }
        throw zzbxs.zzaeM();
    ...
    public int zzaey() throws IOException {
        return (((zzaeD() & MotionEventCompat.ACTION_MASK) | ((zzaeD() & MotionEventCompat.ACTION_MASK) << 8)) | ((zzaeD() & MotionEventCompat.ACTION_MASK) << 16)) | ((zzaeD() & MotionEventCompat.ACTION_MASK) << 24);
    }
