...
public class zzaw {
    private static final String[] zzqc;
    private String zzpY;
    private String zzpZ;
    private String zzqa;
    private String[] zzqb;
    ...
    static {
        zzqc = new String[]{"/aclk", "/pcs/click"};
    }

    public zzaw(zzar com_google_android_gms_internal_zzar) {
        this.zzpY = "googleads.g.doubleclick.net";
        this.zzpZ = "/pagead/ads";
        this.zzqa = "ad.doubleclick.net";
        this.zzqb = new String[]{".doubleclick.net", ".googleadservices.com", ".googlesyndication.com"};
