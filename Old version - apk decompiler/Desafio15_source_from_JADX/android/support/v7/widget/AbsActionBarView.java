...
abstract class AbsActionBarView extends ViewGroup {
    ...
    AbsActionBarView(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (!context.getTheme().resolveAttribute(C0122R.attr.actionBarPopupTheme, tv, true) || tv.resourceId == 0) {
    ...
    protected void onConfigurationChanged(Configuration newConfig) {
        ...
        TypedArray a = getContext().obtainStyledAttributes(null, C0122R.styleable.ActionBar, C0122R.attr.actionBarStyle, 0);
        setContentHeight(a.getLayoutDimension(C0122R.styleable.ActionBar_height, 0));
        a.recycle();
