...
public class zzpp {
    ...
    public static class zzb extends zza {
        ...
        class C03981 implements Callable<Boolean> {
            final /* synthetic */ WebSettings zzXJ;
            final /* synthetic */ Context zztf;

            C03981(zzb com_google_android_gms_internal_zzpp_zzb, Context context, WebSettings webSettings) {
                this.zztf = context;
        ...
        public boolean zza(Context context, WebSettings webSettings) {
            ...
            return ((Boolean) zzqb.zzb(new C03981(this, context, webSettings))).booleanValue();
        }
