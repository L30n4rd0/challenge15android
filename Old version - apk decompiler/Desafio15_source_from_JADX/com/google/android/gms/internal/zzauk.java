...
public class zzauk extends zzauh {
    ...
    private zzf zzbvs;
    private long zzbvt;
    private final Map<Activity, zza> zzbvu;
    private final CopyOnWriteArrayList<zzd> zzbvv;
    private boolean zzbvw;
    private zzf zzbvx;
    private String zzbvy;

    /* renamed from: com.google.android.gms.internal.zzauk.1 */
    class C02731 implements Runnable {
        final /* synthetic */ zza zzbvA;
        final /* synthetic */ zzauk zzbvB;
        final /* synthetic */ boolean zzbvz;

        C02731(zzauk com_google_android_gms_internal_zzauk, boolean z, zza com_google_android_gms_internal_zzauk_zza) {
            this.zzbvB = com_google_android_gms_internal_zzauk;
            this.zzbvz = z;
            this.zzbvA = com_google_android_gms_internal_zzauk_zza;
        }

        public void run() {
            if (this.zzbvz && this.zzbvB.zzbvq != null) {
                this.zzbvB.zza(this.zzbvB.zzbvq);
            }
            this.zzbvB.zzbvq = this.zzbvA;
            this.zzbvB.zzKc().zza(this.zzbvA);
        }
    }

    /* renamed from: com.google.android.gms.internal.zzauk.2 */
    class C02742 implements Runnable {
        final /* synthetic */ zzauk zzbvB;
        final /* synthetic */ zza zzbvC;

        C02742(zzauk com_google_android_gms_internal_zzauk, zza com_google_android_gms_internal_zzauk_zza) {
            this.zzbvB = com_google_android_gms_internal_zzauk;
            this.zzbvC = com_google_android_gms_internal_zzauk_zza;
        }

        public void run() {
            this.zzbvB.zza(this.zzbvC);
    ...
    public zzauk(zzaue com_google_android_gms_internal_zzaue) {
        ...
        this.zzbvu = new ArrayMap();
        this.zzbvv = new CopyOnWriteArrayList();
    }

    @MainThread
    private void zza(Activity activity, zza com_google_android_gms_internal_zzauk_zza, boolean z) {
        int i = 1;
        ...
        if (i != 0) {
            ...
            zzf com_google_android_gms_internal_zzauk_zza2 = new zza(com_google_android_gms_internal_zzauk_zza);
            this.zzbvs = this.zzbvr;
            this.zzbvt = zznR().elapsedRealtime();
            this.zzbvr = com_google_android_gms_internal_zzauk_zza2;
            zzKj().zzm(new C02731(this, z, com_google_android_gms_internal_zzauk_zza2));
        }
    }
