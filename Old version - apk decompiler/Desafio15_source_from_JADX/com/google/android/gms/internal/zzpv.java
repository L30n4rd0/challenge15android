...
public class zzpv {
    ...
    class C06851 implements zza<Void> {
        C06851() {
        }
    ...
    class C06862 implements com.google.android.gms.internal.zzn.zza {
        final /* synthetic */ zzc zzYp;
        final /* synthetic */ String zzsg;

        C06862(zzpv com_google_android_gms_internal_zzpv, String str, zzc com_google_android_gms_internal_zzpv_zzc) {
            this.zzsg = str;
    ...
    private static class zzb<T> extends zzl<InputStream> {
        ...
        class C04072 implements Callable<T> {
            final /* synthetic */ InputStream zzYv;
            final /* synthetic */ zzb zzYw;

            C04072(zzb com_google_android_gms_internal_zzpv_zzb, InputStream inputStream) {
        ...
        class C04083 implements Runnable {
            final /* synthetic */ zzb zzYw;
            final /* synthetic */ zzqm zzYx;

            C04083(zzb com_google_android_gms_internal_zzpv_zzb, zzqm com_google_android_gms_internal_zzqm) {
                this.zzYw = com_google_android_gms_internal_zzpv_zzb;
        ...
        class C06871 implements com.google.android.gms.internal.zzn.zza {
            final /* synthetic */ com.google.android.gms.internal.zzn.zzb zzYt;
            final /* synthetic */ zza zzYu;

            C06871(com.google.android.gms.internal.zzn.zzb com_google_android_gms_internal_zzn_zzb, zza com_google_android_gms_internal_zzpv_zza) {
        ...
        public zzb(String str, zza<T> com_google_android_gms_internal_zzpv_zza_T, com.google.android.gms.internal.zzn.zzb<T> com_google_android_gms_internal_zzn_zzb_T) {
            super(0, str, new C06871(com_google_android_gms_internal_zzn_zzb_T, com_google_android_gms_internal_zzpv_zza_T));
        ...
        protected void zzi(InputStream inputStream) {
            zzqm zza = zzpn.zza(new C04072(this, inputStream));
            zza.zzd(new C04083(this, zza));
        }
    }

    /* renamed from: com.google.android.gms.internal.zzpv.3 */
    class C07113 extends zzac {
        final /* synthetic */ byte[] zzYq;
        final /* synthetic */ Map zzYr;

        C07113(zzpv com_google_android_gms_internal_zzpv, int i, String str, com.google.android.gms.internal.zzn.zzb com_google_android_gms_internal_zzn_zzb, com.google.android.gms.internal.zzn.zza com_google_android_gms_internal_zzn_zza, byte[] bArr, Map map) {
            this.zzYq = bArr;
            this.zzYr = map;
    ...
    public zzqm<String> zza(int i, String str, @Nullable Map<String, String> map, @Nullable byte[] bArr) {
        ...
        zzYm.zze(new C07113(this, i, str, com_google_android_gms_internal_zzpv_zzc, new C06862(this, str, com_google_android_gms_internal_zzpv_zzc), bArr, map));
