...
public class zzjy implements zzjp {
    ...
    class C03401 implements Runnable {
        ...
        C03401(zzjy com_google_android_gms_internal_zzjy, zzjv com_google_android_gms_internal_zzjv) {
            ...
            for (String str2 : com_google_android_gms_internal_zzjq.zzKp) {
                ...
                synchronized (this.zzrJ) {
                    ...
                    if (com_google_android_gms_internal_zzjv.zzLj != null) {
                        zzpo.zzXC.post(new C03401(this, com_google_android_gms_internal_zzjv));
                    }
                }
            }
        }
