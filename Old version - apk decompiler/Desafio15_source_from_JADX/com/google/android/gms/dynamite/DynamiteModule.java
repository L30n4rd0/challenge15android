...
public final class DynamiteModule {
    ...
    class C02178 extends PathClassLoader {
        C02178(String str, ClassLoader classLoader) {
    ...
    private static ClassLoader zzBS() {
        return new C02178(zzaRS, ClassLoader.getSystemClassLoader());
    }
        ...
        if (zza.zzaSd == 0 || ((zza.zzaSd == -1 && zza.zzaSb == 0) || (zza.zzaSd == 1 && zza.zzaSc == 0))) {
            ...
            if (zza.zzaSd == 1) {
                try {
                    ...
                    if (zza.zzaSb != 0 && com_google_android_gms_dynamite_DynamiteModule_zzb.zza(context, str, new C05457(zza.zzaSb)).zzaSd == -1) {
                        return zzJ(context, str);
                    }
