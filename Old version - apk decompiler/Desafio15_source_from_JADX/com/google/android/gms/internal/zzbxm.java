...
public final class zzbxm {
    ...
    public static class zza extends IOException {
        zza(int i, int i2) {
            super(new StringBuilder(C0453R.styleable.AppCompatTheme_ratingBarStyle).append("CodedOutputStream was writing to a flat byte array and ran out of space (pos ").append(i).append(" limit ").append(i2).append(").").toString());
        }
    }
    ...
    public void zzbh(long j) throws IOException {
        while ((-128 & j) != 0) {
            zzrh((((int) j) & TransportMediator.KEYCODE_MEDIA_PAUSE) | TransportMediator.FLAG_KEY_MEDIA_NEXT);
            j >>>= 7;
        }
        zzrh((int) j);
    }
    ...
    public void zzrj(int i) throws IOException {
        while ((i & -128) != 0) {
            zzrh((i & TransportMediator.KEYCODE_MEDIA_PAUSE) | TransportMediator.FLAG_KEY_MEDIA_NEXT);
            i >>>= 7;
        }
        zzrh(i);
    }
