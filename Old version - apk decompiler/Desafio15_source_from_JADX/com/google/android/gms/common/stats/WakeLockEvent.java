...
public final class WakeLockEvent extends StatsEvent {
    ...
    public String zzyL() {
        ...
        String join = zzyQ() == null ? BuildConfig.FLAVOR : TextUtils.join(",", zzyQ());
        String valueOf5 = String.valueOf("\t");
        int zzyT = zzyT();
        String valueOf6 = String.valueOf("\t");
        String zzyN = zzyN() == null ? BuildConfig.FLAVOR : zzyN();
        String valueOf7 = String.valueOf("\t");
        String zzyU = zzyU() == null ? BuildConfig.FLAVOR : zzyU();
