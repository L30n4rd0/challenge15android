...
class zzra extends WebView implements OnGlobalLayoutListener, DownloadListener, zzqw {
    ...
    class C04182 implements Runnable {
        ...
        C04182(zzra com_google_android_gms_internal_zzra) {
    ...
    class C06891 implements zzid {
        final /* synthetic */ zzra zzaax;

        C06891(zzra com_google_android_gms_internal_zzra) {
            this.zzaax = com_google_android_gms_internal_zzra;
        }
    ...
    public void destroy() {
        synchronized (this.zzrJ) {
            ...
            zzmj();
            this.zzaae = true;
            zzpk.m13v("Initiating WebView self destruct sequence in 3...");
            this.zzaab.zzlS();
        }
    }
        ...
        synchronized (this.zzrJ) {
            if (isDestroyed()) {
                ...
                if (this.zzus.widthPixels > mode || this.zzus.heightPixels > r0) {
                    ...
                    zzqf.zzbh(new StringBuilder(C0453R.styleable.AppCompatTheme_buttonStyleSmall).append("Not enough space to show ad. Needs ").append((int) (((float) this.zzus.widthPixels) / r0)).append("x").append(mode2).append(" dp, but only has ").append(size).append("x").append((int) (((float) r1) / r0)).append(" dp.").toString());
                    if (getVisibility() != 8) {
                        setVisibility(4);
                    }
                    setMeasuredDimension(0, 0);
    ...
    public void zzlA() {
        synchronized (this.zzrJ) {
            zzpk.m13v("Destroying WebView!");
            zzkC();
            zzpo.zzXC.post(new C04182(this));
        }
    }
