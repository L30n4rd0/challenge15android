...
public class zzq extends zza {
    ...
    class C01981 implements Runnable {
        ...
        class C01971 implements Runnable {
            final /* synthetic */ C01981 zzuf;

            C01971(C01981 c01981) {
                this.zzuf = c01981;
            }
        ...
        C01981(zzq com_google_android_gms_ads_internal_zzq, Runnable runnable) {
            this.zzue = com_google_android_gms_ads_internal_zzq;
            this.zzud = runnable;
        }

        public void run() {
            zzw.zzcM().runOnUiThread(new C01971(this));
        }
    }
    ...
    public void zzc(String str, IObjectWrapper iObjectWrapper) {
        if (!TextUtils.isEmpty(str)) {
            ...
            if (((Boolean) zzgd.zzCN.get()).booleanValue()) {
                c01981 = new C01981(this, (Runnable) zzd.zzF(iObjectWrapper));
                i = 1;
            } else {
                c01981 = null;
                i = booleanValue;
            ...
            if (i != 0) {
                zzw.zzdi().zza(this.mContext, this.zzuc, str, c01981);
            }
        }
    }
