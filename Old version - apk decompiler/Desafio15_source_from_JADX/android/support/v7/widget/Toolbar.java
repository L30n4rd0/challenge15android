...
public class Toolbar extends ViewGroup {
    ...
    class C01543 implements OnClickListener {
        C01543() {
        }
    ...
    class C05081 implements android.support.v7.widget.ActionMenuView.OnMenuItemClickListener {
        C05081() {
        }
    ...
    private class ExpandedActionViewMenuPresenter implements MenuPresenter {
        ...
        public boolean expandItemActionView(MenuBuilder menu, MenuItemImpl item) {
            ...
            if (Toolbar.this.mExpandedActionView.getParent() != Toolbar.this) {
                ...
                lp.gravity = GravityCompat.START | (Toolbar.this.mButtonGravity & C0453R.styleable.AppCompatTheme_spinnerStyle);
                lp.mViewType = 2;
    ...
    public static class SavedState extends AbsSavedState {
        ...
        static class C05091 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C05091() {
            }
        ...
        static {
            CREATOR = ParcelableCompat.newCreator(new C05091());
        }
    }
    ...
    public Toolbar(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, C0122R.attr.toolbarStyle);
    }
    ...
    public Toolbar(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        this.mMenuViewItemClickListener = new C05081();
        this.mShowOverflowMenuRunnable = new C01532();
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(getContext(), attrs, C0122R.styleable.Toolbar, defStyleAttr, 0);
        this.mTitleTextAppearance = a.getResourceId(C0122R.styleable.Toolbar_titleTextAppearance, 0);
        this.mSubtitleTextAppearance = a.getResourceId(C0122R.styleable.Toolbar_subtitleTextAppearance, 0);
        this.mGravity = a.getInteger(C0122R.styleable.Toolbar_android_gravity, this.mGravity);
        this.mButtonGravity = a.getInteger(C0122R.styleable.Toolbar_buttonGravity, 48);
        int titleMargin = a.getDimensionPixelOffset(C0122R.styleable.Toolbar_titleMargin, 0);
        if (a.hasValue(C0122R.styleable.Toolbar_titleMargins)) {
            titleMargin = a.getDimensionPixelOffset(C0122R.styleable.Toolbar_titleMargins, titleMargin);
        }
        ...
        int marginStart = a.getDimensionPixelOffset(C0122R.styleable.Toolbar_titleMarginStart, -1);
        if (marginStart >= 0) {
            this.mTitleMarginStart = marginStart;
        }
        int marginEnd = a.getDimensionPixelOffset(C0122R.styleable.Toolbar_titleMarginEnd, -1);
        if (marginEnd >= 0) {
            this.mTitleMarginEnd = marginEnd;
        }
        int marginTop = a.getDimensionPixelOffset(C0122R.styleable.Toolbar_titleMarginTop, -1);
        if (marginTop >= 0) {
            this.mTitleMarginTop = marginTop;
        }
        int marginBottom = a.getDimensionPixelOffset(C0122R.styleable.Toolbar_titleMarginBottom, -1);
        if (marginBottom >= 0) {
            this.mTitleMarginBottom = marginBottom;
        }
        this.mMaxButtonHeight = a.getDimensionPixelSize(C0122R.styleable.Toolbar_maxButtonHeight, -1);
        int contentInsetStart = a.getDimensionPixelOffset(C0122R.styleable.Toolbar_contentInsetStart, ExploreByTouchHelper.INVALID_ID);
        int contentInsetEnd = a.getDimensionPixelOffset(C0122R.styleable.Toolbar_contentInsetEnd, ExploreByTouchHelper.INVALID_ID);
        int contentInsetLeft = a.getDimensionPixelSize(C0122R.styleable.Toolbar_contentInsetLeft, 0);
        int contentInsetRight = a.getDimensionPixelSize(C0122R.styleable.Toolbar_contentInsetRight, 0);
        ensureContentInsets();
        ...
        this.mContentInsetStartWithNavigation = a.getDimensionPixelOffset(C0122R.styleable.Toolbar_contentInsetStartWithNavigation, ExploreByTouchHelper.INVALID_ID);
        this.mContentInsetEndWithActions = a.getDimensionPixelOffset(C0122R.styleable.Toolbar_contentInsetEndWithActions, ExploreByTouchHelper.INVALID_ID);
        this.mCollapseIcon = a.getDrawable(C0122R.styleable.Toolbar_collapseIcon);
        this.mCollapseDescription = a.getText(C0122R.styleable.Toolbar_collapseContentDescription);
        CharSequence title = a.getText(C0122R.styleable.Toolbar_title);
        if (!TextUtils.isEmpty(title)) {
            setTitle(title);
        }
        CharSequence subtitle = a.getText(C0122R.styleable.Toolbar_subtitle);
        if (!TextUtils.isEmpty(subtitle)) {
            setSubtitle(subtitle);
        }
        this.mPopupContext = getContext();
        setPopupTheme(a.getResourceId(C0122R.styleable.Toolbar_popupTheme, 0));
        Drawable navIcon = a.getDrawable(C0122R.styleable.Toolbar_navigationIcon);
        if (navIcon != null) {
            setNavigationIcon(navIcon);
        }
        CharSequence navDesc = a.getText(C0122R.styleable.Toolbar_navigationContentDescription);
        if (!TextUtils.isEmpty(navDesc)) {
            setNavigationContentDescription(navDesc);
        }
        Drawable logo = a.getDrawable(C0122R.styleable.Toolbar_logo);
        if (logo != null) {
            setLogo(logo);
        }
        CharSequence logoDesc = a.getText(C0122R.styleable.Toolbar_logoDescription);
        if (!TextUtils.isEmpty(logoDesc)) {
            setLogoDescription(logoDesc);
        }
        if (a.hasValue(C0122R.styleable.Toolbar_titleTextColor)) {
            setTitleTextColor(a.getColor(C0122R.styleable.Toolbar_titleTextColor, -1));
        }
        if (a.hasValue(C0122R.styleable.Toolbar_subtitleTextColor)) {
            setSubtitleTextColor(a.getColor(C0122R.styleable.Toolbar_subtitleTextColor, -1));
        }
        a.recycle();
    }
    ...
    private void ensureMenuView() {
        if (this.mMenuView == null) {
            ...
            lp.gravity = GravityCompat.END | (this.mButtonGravity & C0453R.styleable.AppCompatTheme_spinnerStyle);
    ...
    private void ensureNavButtonView() {
        if (this.mNavButtonView == null) {
            this.mNavButtonView = new AppCompatImageButton(getContext(), null, C0122R.attr.toolbarNavigationButtonStyle);
            LayoutParams lp = generateDefaultLayoutParams();
            lp.gravity = GravityCompat.START | (this.mButtonGravity & C0453R.styleable.AppCompatTheme_spinnerStyle);
    ...
    void ensureCollapseButtonView() {
        if (this.mCollapseButtonView == null) {
            this.mCollapseButtonView = new AppCompatImageButton(getContext(), null, C0122R.attr.toolbarNavigationButtonStyle);
            ...
            this.mCollapseButtonView.setOnClickListener(new C01543());
        }
    }
    ...
    private int getChildTop(View child, int alignmentHeight) {
        ...
        switch (getChildVerticalGravity(lp.gravity)) {
            ...
            case C0453R.styleable.AppCompatTheme_panelMenuListWidth /*80*/:
    ...
    private int getChildVerticalGravity(int gravity) {
        int vgrav = gravity & C0453R.styleable.AppCompatTheme_spinnerStyle;
        switch (vgrav) {
            ...
            case C0453R.styleable.AppCompatTheme_panelMenuListWidth /*80*/:
                return vgrav;
            default:
                return this.mGravity & C0453R.styleable.AppCompatTheme_spinnerStyle;
        }
    }
