...
public class zzi {
    ...
    class C01801 implements Runnable {
        ...
        class C01791 implements ServiceConnection {
            final /* synthetic */ C01801 zzPO;
        ...
        C01801(zzi com_google_android_gms_ads_internal_purchase_zzi, Context context) {
            this.zztf = context;
        }

        public void run() {
            ServiceConnection c01791 = new C01791(this);
            Intent intent = new Intent("com.android.vending.billing.InAppBillingService.BIND");
            intent.setPackage(GooglePlayServicesUtil.GOOGLE_PLAY_STORE_PACKAGE);
            zza.zzyJ().zza(this.zztf, intent, c01791, 1);
        }
    }
    ...
    public void zzv(Context context) {
        zzpo.zzb(new C01801(this, context));
    }
}
