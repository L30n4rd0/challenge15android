...
public class zzmc implements zzmd {
    ...
    class C03691 implements UncaughtExceptionHandler {
        final /* synthetic */ UncaughtExceptionHandler zzRi;
        final /* synthetic */ zzmc zzRj;

        C03691(zzmc com_google_android_gms_internal_zzmc, UncaughtExceptionHandler uncaughtExceptionHandler) {
    ...
    class C03702 implements UncaughtExceptionHandler {
        final /* synthetic */ zzmc zzRj;
        final /* synthetic */ UncaughtExceptionHandler zzRk;

        C03702(zzmc com_google_android_gms_internal_zzmc, UncaughtExceptionHandler uncaughtExceptionHandler) {
            this.zzRj = com_google_android_gms_internal_zzmc;
    ...
    private void zzjk() {
        Thread.setDefaultUncaughtExceptionHandler(new C03691(this, Thread.getDefaultUncaughtExceptionHandler()));
    }
    ...
    public void zza(Thread thread) {
        if (thread != null) {
            ...
            thread.setUncaughtExceptionHandler(new C03702(this, thread.getUncaughtExceptionHandler()));
        }
    }
