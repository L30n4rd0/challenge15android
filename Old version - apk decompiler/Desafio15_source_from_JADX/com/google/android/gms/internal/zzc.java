...
public class zzc extends Thread {
    ...
    class C02961 implements Runnable {
        ...
        C02961(zzc com_google_android_gms_internal_zzc, zzl com_google_android_gms_internal_zzl) {
            ...
            try {
                ...
                if (zza == null) {
                    ...
                    if (zza.zzb()) {
                        ...
                        com_google_android_gms_internal_zzl.zza(zza);
                        zza2.zzah = true;
                        this.zzj.zza(com_google_android_gms_internal_zzl, zza2, new C02961(this, com_google_android_gms_internal_zzl));
                    } else {
