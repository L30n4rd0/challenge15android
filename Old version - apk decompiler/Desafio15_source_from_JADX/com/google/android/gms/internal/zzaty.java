        ...
        public void run() {
            ...
            try {
                ...
                try {
                    ...
                    if (this.zzaIQ != null) {
                        ...
                        try {
                            ...
                            this.zzbsY.zzKj().zzm(new zzb(this.zzbsW, i, e, null, map, null));
                        } catch (Throwable th2) {
                            th = th2;
                            map2 = null;
                            if (outputStream != null) {
                            ...
                            this.zzbsY.zzKj().zzm(new zzb(this.zzbsW, i2, null, null, map2, null));
                            throw th;
                        }
                    }
                ...
                try {
                    ...
                    this.zzbsY.zzKj().zzm(new zzb(this.zzbsW, i2, null, zza, map2, null));
