...
public class zzaaq implements zzaau {
    ...
    class C05491 extends zza {
        final /* synthetic */ zzaaq zzaBm;

        C05491(zzaaq com_google_android_gms_internal_zzaaq, zzaau com_google_android_gms_internal_zzaau) {
    ...
    class C05502 extends zza {
        final /* synthetic */ zzaaq zzaBm;

        C05502(zzaaq com_google_android_gms_internal_zzaaq, zzaau com_google_android_gms_internal_zzaau) {
            this.zzaBm = com_google_android_gms_internal_zzaaq;
            super(com_google_android_gms_internal_zzaau);
        }
    ...
    public void connect() {
        if (this.zzaBl) {
            this.zzaBl = false;
            this.zzaBk.zza(new C05502(this, this));
        }
    }
    ...
    public <A extends zzb, T extends zza<? extends Result, A>> T zzb(T t) {
        try {
            ...
            this.zzaBk.zza(new C05491(this, this));
        }
        return t;
    }
