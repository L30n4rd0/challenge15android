...
public class zzabr extends zzbam implements ConnectionCallbacks, OnConnectionFailedListener {
    private static com.google.android.gms.common.api.Api.zza<? extends zzbai, zzbaj> zzaDg;
    ...
    /* renamed from: com.google.android.gms.internal.zzabr.1 */
    class C02351 implements Runnable {
        final /* synthetic */ zzbaw zzaBI;
        final /* synthetic */ zzabr zzaDj;

        C02351(zzabr com_google_android_gms_internal_zzabr, zzbaw com_google_android_gms_internal_zzbaw) {
            this.zzaDj = com_google_android_gms_internal_zzabr;
            this.zzaBI = com_google_android_gms_internal_zzbaw;
        }

        public void run() {
            this.zzaDj.zzc(this.zzaBI);
        }
    }
    ...
    public void zzb(zzbaw com_google_android_gms_internal_zzbaw) {
        this.mHandler.post(new C02351(this, com_google_android_gms_internal_zzbaw));
    }
