...
public abstract class MediaBrowserServiceCompat extends Service {
    ...
    private class ServiceBinderImpl {
        ...
        class C00423 implements Runnable {
            ...
            C00423(ServiceCallbacks serviceCallbacks, String str, IBinder iBinder, Bundle bundle) {
                this.val$callbacks = serviceCallbacks;
                this.val$id = str;
        ...
        class C00434 implements Runnable {
            ...
            C00434(ServiceCallbacks serviceCallbacks, String str, IBinder iBinder) {
                this.val$callbacks = serviceCallbacks;
                this.val$id = str;
                this.val$token = iBinder;
            }
        ...
        class C00445 implements Runnable {
            ...
            C00445(ServiceCallbacks serviceCallbacks, String str, ResultReceiver resultReceiver) {
                this.val$callbacks = serviceCallbacks;
        ...
        class C00456 implements Runnable {
            ...
            C00456(ServiceCallbacks serviceCallbacks, Bundle bundle) {
                this.val$callbacks = serviceCallbacks;
                this.val$rootHints = bundle;
            }
        ...
        public void addSubscription(String id, IBinder token, Bundle options, ServiceCallbacks callbacks) {
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new C00423(callbacks, id, token, options));
        }

        public void removeSubscription(String id, IBinder token, ServiceCallbacks callbacks) {
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new C00434(callbacks, id, token));
        }

        public void getMediaItem(String mediaId, ResultReceiver receiver, ServiceCallbacks callbacks) {
            if (!TextUtils.isEmpty(mediaId) && receiver != null) {
                MediaBrowserServiceCompat.this.mHandler.postOrRun(new C00445(callbacks, mediaId, receiver));
            }
        }

        public void registerCallbacks(ServiceCallbacks callbacks, Bundle rootHints) {
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new C00456(callbacks, rootHints));
        }
    ...
    class C04631 extends Result<List<MediaItem>> {
        final /* synthetic */ ConnectionRecord val$connection;
        final /* synthetic */ Bundle val$options;
        final /* synthetic */ String val$parentId;

        C04631(Object debug, ConnectionRecord connectionRecord, String str, Bundle bundle) {
    ...
    class C04642 extends Result<MediaItem> {
        final /* synthetic */ ResultReceiver val$receiver;

        C04642(Object debug, ResultReceiver resultReceiver) {
            this.val$receiver = resultReceiver;
            super(debug);
        }
    ...
    class MediaBrowserServiceImplApi21 implements MediaBrowserServiceImpl, ServiceCompatProxy {
        ...
        class C00371 implements Runnable {
            ...
            C00371(String str, Bundle bundle) {
                this.val$parentId = str;
                this.val$options = bundle;
            }
        ...
        class C04652 extends Result<List<MediaItem>> {
            final /* synthetic */ ResultWrapper val$resultWrapper;

            C04652(Object debug, ResultWrapper resultWrapper) {
        ...
        public void notifyChildrenChanged(String parentId, Bundle options) {
            if (this.mMessenger == null) {
                ...
                MediaBrowserServiceCompat.this.mHandler.post(new C00371(parentId, options));
            }
        }
        ...
        public void onLoadChildren(String parentId, ResultWrapper<List<Parcel>> resultWrapper) {
            MediaBrowserServiceCompat.this.onLoadChildren(parentId, new C04652(parentId, resultWrapper));
        }
    }
    ...
    class MediaBrowserServiceImplBase implements MediaBrowserServiceImpl {
        ...
        public void setSessionToken(Token token) {
            MediaBrowserServiceCompat.this.mHandler.post(new C00381(token));
        }

        public void notifyChildrenChanged(@NonNull String parentId, Bundle options) {
            MediaBrowserServiceCompat.this.mHandler.post(new C00392(parentId, options));
        }
    ...
    class MediaBrowserServiceImplApi23 extends MediaBrowserServiceImplApi21 implements MediaBrowserServiceCompatApi23.ServiceCompatProxy {
        ...
        class C04661 extends Result<MediaItem> {
            final /* synthetic */ ResultWrapper val$resultWrapper;

            C04661(Object debug, ResultWrapper resultWrapper) {
                this.val$resultWrapper = resultWrapper;
                super(debug);
            }
        ...
        public void onLoadItem(String itemId, ResultWrapper<Parcel> resultWrapper) {
            MediaBrowserServiceCompat.this.onLoadItem(itemId, new C04661(itemId, resultWrapper));
        }
    }
    ...
    class MediaBrowserServiceImplApi24 extends MediaBrowserServiceImplApi23 implements MediaBrowserServiceCompatApi24.ServiceCompatProxy {
        ...
        class C04671 extends Result<List<MediaItem>> {
            final /* synthetic */ ResultWrapper val$resultWrapper;

            C04671(Object debug, ResultWrapper resultWrapper) {
                this.val$resultWrapper = resultWrapper;
                super(debug);
            }
        ...
        public void onLoadChildren(String parentId, ResultWrapper resultWrapper, Bundle options) {
            MediaBrowserServiceCompat.this.onLoadChildren(parentId, new C04671(parentId, resultWrapper), options);
        }
    ...
    void performLoadChildren(String parentId, ConnectionRecord connection, Bundle options) {
        Result<List<MediaItem>> result = new C04631(parentId, connection, parentId, options);
    ...
    void performLoadItem(String itemId, ConnectionRecord connection, ResultReceiver receiver) {
        Result<MediaItem> result = new C04642(itemId, receiver);
        this.mCurConnection = connection;
