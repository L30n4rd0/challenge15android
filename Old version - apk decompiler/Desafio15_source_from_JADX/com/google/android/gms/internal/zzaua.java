...
class zzaua extends zzauh {
    static final Pair<String, Long> zzbtb;
    private SharedPreferences zzagD;
    public final zzc zzbtc;
    public final zzb zzbtd;
    public final zzb zzbte;
    public final zzb zzbtf;
    public final zzb zzbtg;
    ...
    public final zzb zzbtq;
    public final zza zzbtr;
    public final zzb zzbts;
    public final zzb zzbtt;
    ...
    static {
        zzbtb = new Pair(BuildConfig.FLAVOR, Long.valueOf(0));
    }

    zzaua(zzaue com_google_android_gms_internal_zzaue) {
        super(com_google_android_gms_internal_zzaue);
        this.zzbtc = new zzc("health_monitor", zzKm().zzpz(), null);
        this.zzbtd = new zzb(this, "last_upload", 0);
        this.zzbte = new zzb(this, "last_upload_attempt", 0);
        this.zzbtf = new zzb(this, "backoff", 0);
        this.zzbtg = new zzb(this, "last_delete_stale", 0);
        this.zzbtp = new zzb(this, "time_before_start", 10000);
        this.zzbtq = new zzb(this, "session_timeout", 1800000);
        this.zzbtr = new zza(this, "start_new_session", true);
        this.zzbts = new zzb(this, "last_pause_time", 0);
        this.zzbtt = new zzb(this, "time_active", 0);
        this.zzbth = new zzb(this, "midnight_offset", 0);
