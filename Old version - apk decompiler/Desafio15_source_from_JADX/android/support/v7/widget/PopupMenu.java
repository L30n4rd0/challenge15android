...
public class PopupMenu {
    ...
    class C01412 implements android.widget.PopupWindow.OnDismissListener {
        C01412() {
        }
    ...
    class C05051 implements Callback {
        C05051() {
        }
    ...
    class C05063 extends ForwardingListener {
        C05063(View src) {
            super(src);
        }
    ...
    public PopupMenu(@NonNull Context context, @NonNull View anchor, int gravity) {
        this(context, anchor, gravity, C0122R.attr.popupMenuStyle, 0);
    }
    ...
    public PopupMenu(@NonNull Context context, @NonNull View anchor, int gravity, @AttrRes int popupStyleAttr, @StyleRes int popupStyleRes) {
        ...
        this.mMenu.setCallback(new C05051());
        ...
        this.mPopup.setOnDismissListener(new C01412());
    }
    ...
    public OnTouchListener getDragToOpenListener() {
        if (this.mDragListener == null) {
            this.mDragListener = new C05063(this.mAnchor);
        }
