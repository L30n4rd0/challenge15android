...
public final class zznd {
        ...
        try {
            ...
            if (com_google_android_gms_internal_zzmn != null) {
                ...
                if (com_google_android_gms_internal_zzmn.zzSm > 0) {
                    ...
                    return new zzmn(com_google_android_gms_internal_zzmk, optString2, str2, list, list2, j3, jSONObject.optBoolean("mediation", false), jSONObject.optLong("mediation_config_cache_time_milliseconds", -1), list3, jSONObject.optLong("refresh_interval_milliseconds", -1), i, optString4, j, optString7, optBoolean, str3, optString9, jSONObject.optBoolean("custom_render_allowed", false), z, com_google_android_gms_internal_zzmk.zzRG, jSONObject.optBoolean("content_url_opted_out", true), jSONObject.optBoolean("prefetch", false), jSONObject.optString("gws_query_id", BuildConfig.FLAVOR), "height".equals(jSONObject.optString("fluid", BuildConfig.FLAVOR)), jSONObject.optBoolean("native_express", false), zzoo.zza(jSONObject.optJSONArray("rewards")), zza(jSONObject.optJSONArray("video_start_urls"), null), zza(jSONObject.optJSONArray("video_complete_urls"), null), jSONObject.optBoolean("use_displayed_impression", false), zzmp.zzf(jSONObject.optJSONObject("auto_protection_configuration")), com_google_android_gms_internal_zzmk.zzRV, jSONObject.optString("set_cookie", BuildConfig.FLAVOR), zza(jSONObject.optJSONArray("remote_ping_urls"), null), jSONObject.optBoolean("render_in_browser", com_google_android_gms_internal_zzmk.zzKJ), optString5, zzor.zzh(jSONObject.optJSONObject("safe_browsing")), optString8, jSONObject.optBoolean("content_vertical_opted_out", true), com_google_android_gms_internal_zzmk.zzSh);
                }
            }
            j3 = j2;
            optString9 = jSONObject.optString("active_view");
    ...
    public static JSONObject zza(Context context, zzna com_google_android_gms_internal_zzna) {
        ...
        if (zzqf.zzak(2)) {
            ...
            zzpk.m13v(valueOf.length() != 0 ? str.concat(valueOf) : new String(str));
        }
    ...
    public static JSONObject zzb(zzmn com_google_android_gms_internal_zzmn) throws JSONException {
        ...
        jSONObject.put("fluid", com_google_android_gms_internal_zzmn.zzzC ? "height" : BuildConfig.FLAVOR);
