...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    class C01464 implements OnFocusChangeListener {
        C01464() {
        }
    ...
    class C01475 implements OnLayoutChangeListener {
        C01475() {
        }
    ...
    class C01486 implements OnGlobalLayoutListener {
        C01486() {
        }
    ...
    class C01497 implements OnClickListener {
        C01497() {
        }
    ...
    class C01508 implements OnKeyListener {
        C01508() {
        }
    ...
    class C01519 implements OnEditorActionListener {
        C01519() {
        }
    ...
    static class SavedState extends AbsSavedState {
        ...
        static class C05071 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C05071() {
            }
        ...
        static {
            CREATOR = ParcelableCompat.newCreator(new C05071());
        }
    }
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        public SearchAutoComplete(Context context, AttributeSet attrs) {
            this(context, attrs, C0122R.attr.autoCompleteTextViewStyle);
        }
    ...
    public SearchView(Context context, AttributeSet attrs) {
        this(context, attrs, C0122R.attr.searchViewStyle);
    }
    ...
    public SearchView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mShowImeRunnable = new C01431();
        this.mUpdateDrawableStateRunnable = new C01442();
        this.mReleaseCursorRunnable = new C01453();
        this.mOutsideDrawablesCache = new WeakHashMap();
        this.mOnClickListener = new C01497();
        this.mTextKeyListener = new C01508();
        this.mOnEditorActionListener = new C01519();
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0122R.styleable.SearchView, defStyleAttr, 0);
        LayoutInflater.from(context).inflate(a.getResourceId(C0122R.styleable.SearchView_layout, C0122R.layout.abc_search_view), this, true);
        this.mSearchSrcTextView = (SearchAutoComplete) findViewById(C0122R.id.search_src_text);
        this.mSearchSrcTextView.setSearchView(this);
        this.mSearchEditFrame = findViewById(C0122R.id.search_edit_frame);
        this.mSearchPlate = findViewById(C0122R.id.search_plate);
        this.mSubmitArea = findViewById(C0122R.id.submit_area);
        this.mSearchButton = (ImageView) findViewById(C0122R.id.search_button);
        this.mGoButton = (ImageView) findViewById(C0122R.id.search_go_btn);
        this.mCloseButton = (ImageView) findViewById(C0122R.id.search_close_btn);
        this.mVoiceButton = (ImageView) findViewById(C0122R.id.search_voice_btn);
        this.mCollapsedIcon = (ImageView) findViewById(C0122R.id.search_mag_icon);
        this.mSearchPlate.setBackgroundDrawable(a.getDrawable(C0122R.styleable.SearchView_queryBackground));
        this.mSubmitArea.setBackgroundDrawable(a.getDrawable(C0122R.styleable.SearchView_submitBackground));
        this.mSearchButton.setImageDrawable(a.getDrawable(C0122R.styleable.SearchView_searchIcon));
        this.mGoButton.setImageDrawable(a.getDrawable(C0122R.styleable.SearchView_goIcon));
        this.mCloseButton.setImageDrawable(a.getDrawable(C0122R.styleable.SearchView_closeIcon));
        this.mVoiceButton.setImageDrawable(a.getDrawable(C0122R.styleable.SearchView_voiceIcon));
        this.mCollapsedIcon.setImageDrawable(a.getDrawable(C0122R.styleable.SearchView_searchIcon));
        this.mSearchHintIcon = a.getDrawable(C0122R.styleable.SearchView_searchHintIcon);
        this.mSuggestionRowLayout = a.getResourceId(C0122R.styleable.SearchView_suggestionRowLayout, C0122R.layout.abc_search_dropdown_item_icons_2line);
        this.mSuggestionCommitIconResId = a.getResourceId(C0122R.styleable.SearchView_commitIcon, 0);
        ...
        this.mSearchSrcTextView.setOnFocusChangeListener(new C01464());
        setIconifiedByDefault(a.getBoolean(C0122R.styleable.SearchView_iconifiedByDefault, true));
        int maxWidth = a.getDimensionPixelSize(C0122R.styleable.SearchView_android_maxWidth, -1);
        if (maxWidth != -1) {
            setMaxWidth(maxWidth);
        }
        this.mDefaultQueryHint = a.getText(C0122R.styleable.SearchView_defaultQueryHint);
        this.mQueryHint = a.getText(C0122R.styleable.SearchView_queryHint);
        int imeOptions = a.getInt(C0122R.styleable.SearchView_android_imeOptions, -1);
        if (imeOptions != -1) {
            setImeOptions(imeOptions);
        }
        int inputType = a.getInt(C0122R.styleable.SearchView_android_inputType, -1);
        if (inputType != -1) {
            setInputType(inputType);
        }
        setFocusable(a.getBoolean(C0122R.styleable.SearchView_android_focusable, true));
        a.recycle();
    ...
    private void addOnLayoutChangeListenerToDropDownAnchorSDK11() {
        this.mDropDownAnchor.addOnLayoutChangeListener(new C01475());
    }

    private void addOnLayoutChangeListenerToDropDownAnchorBase() {
        this.mDropDownAnchor.getViewTreeObserver().addOnGlobalLayoutListener(new C01486());
    }
    ...
    private int getPreferredWidth() {
        return getContext().getResources().getDimensionPixelSize(C0122R.dimen.abc_search_view_preferred_width);
    }

    private int getPreferredHeight() {
        return getContext().getResources().getDimensionPixelSize(C0122R.dimen.abc_search_view_preferred_height);
    }
    ...
    void adjustDropDownSizeAndPosition() {
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            int iconOffset = this.mIconifiedByDefault ? res.getDimensionPixelSize(C0122R.dimen.abc_dropdownitem_icon_width) + res.getDimensionPixelSize(C0122R.dimen.abc_dropdownitem_text_padding_left) : 0;
