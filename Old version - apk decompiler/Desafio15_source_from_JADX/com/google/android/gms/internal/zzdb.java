...
public class zzdb {
    ...
    private ArrayList<String> zzxu;
    private ArrayList<String> zzxv;
    private ArrayList<zzdf> zzxw;
    private int zzxx;
    private int zzxy;
    private int zzxz;
    ...
    public zzdb(int i, int i2, int i3, int i4, int i5, int i6, int i7) {
        ...
        this.zzxw = new ArrayList();
        this.zzxx = 0;
        this.zzxy = 0;
        this.zzxz = 0;
        this.zzxB = BuildConfig.FLAVOR;
        this.zzxC = BuildConfig.FLAVOR;
        this.zzxD = BuildConfig.FLAVOR;
        this.zzxp = i;
        this.zzxq = i2;
        this.zzxr = i3;
