...
public abstract class zzaae extends zzabe implements OnCancelListener {
    ...
    private class zza implements Runnable {
        ...
        class C05461 extends com.google.android.gms.internal.zzaaz.zza {
            final /* synthetic */ Dialog zzaAe;
            final /* synthetic */ zza zzaAf;

            C05461(zza com_google_android_gms_internal_zzaae_zza, Dialog dialog) {
        ...
        public void run() {
            ...
            if (this.zzaAd.zzaAa.hasResolution()) {
                ...
                this.zzaAd.zzazn.zza(this.zzaAd.getActivity().getApplicationContext(), new C05461(this, this.zzaAd.zzazn.zza(this.zzaAd.getActivity(), this.zzaAd)));
            } else {
