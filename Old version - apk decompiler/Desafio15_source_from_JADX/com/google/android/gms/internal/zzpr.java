...
public class zzpr {
    ...
    class C03991 implements OnClickListener {
        ...
        C03991(zzpr com_google_android_gms_internal_zzpr, int i, int i2, int i3) {
    ...
    class C04002 implements OnClickListener {
        ...
        C04002(zzpr com_google_android_gms_internal_zzpr, String str) {
            this.zzXR = com_google_android_gms_internal_zzpr;
            this.zzXS = str;
        }
    ...
    class C04013 implements OnClickListener {
        C04013(zzpr com_google_android_gms_internal_zzpr) {
        }
    ...
    class C04024 implements Runnable {
        ...
        C04024(zzpr com_google_android_gms_internal_zzpr) {
            this.zzXR = com_google_android_gms_internal_zzpr;
        }
    ...
    class C04035 implements Runnable {
        ...
        C04035(zzpr com_google_android_gms_internal_zzpr) {
            this.zzXR = com_google_android_gms_internal_zzpr;
        }
    ...
    private void zzkU() {
        if (this.mContext instanceof Activity) {
            ...
            if (resources != null) {
                string = resources.getString(C0156R.string.debug_menu_title);
            } else {
            ...
            new AlertDialog.Builder(this.mContext).setTitle(string).setItems((CharSequence[]) arrayList.toArray(new String[0]), new C03991(this, zza(arrayList, string2, true), zza(arrayList, string3, ((Boolean) zzgd.zzFl.get()).booleanValue()), zza(arrayList, string4, ((Boolean) zzgd.zzFm.get()).booleanValue()))).create().show();
            return;
        }
    ...
    private void zzkV() {
        if (this.mContext instanceof Activity) {
            ...
            builder.setPositiveButton("Share", new C04002(this, zzbc));
            builder.setNegativeButton("Close", new C04013(this));
            builder.create().show();
            return;
        }
        zzqf.zzbg("Can not create dialog without Activity Context");
    ...
    private void zzkW() {
        ...
        zzpn.zza(new C04024(this));
    }

    private void zzkX() {
        zzqf.zzbf("Debug mode [Troubleshooting] selected.");
        zzpn.zza(new C04035(this));
    }
