...
public final class zzabg extends Fragment implements zzabf {
    private static WeakHashMap<Activity, WeakReference<zzabg>> zzaCS;
    private int zzJO;
    private Map<String, zzabe> zzaCT;
    private Bundle zzaCU;

    /* renamed from: com.google.android.gms.internal.zzabg.1 */
    class C02341 implements Runnable {
        final /* synthetic */ String zzP;
        final /* synthetic */ zzabe zzaCV;
        final /* synthetic */ zzabg zzaCW;

        C02341(zzabg com_google_android_gms_internal_zzabg, zzabe com_google_android_gms_internal_zzabe, String str) {
            this.zzaCW = com_google_android_gms_internal_zzabg;
        ...
        public void run() {
            if (this.zzaCW.zzJO >= 1) {
                this.zzaCV.onCreate(this.zzaCW.zzaCU != null ? this.zzaCW.zzaCU.getBundle(this.zzP) : null);
            }
    ...
    private void zzb(String str, @NonNull zzabe com_google_android_gms_internal_zzabe) {
        if (this.zzJO > 0) {
            new Handler(Looper.getMainLooper()).post(new C02341(this, com_google_android_gms_internal_zzabe, str));
        }
    }
