...
public class zzaal {
    ...
    class C05471 implements zza {
        final /* synthetic */ zzaaf zzaBe;
        final /* synthetic */ zzaal zzaBf;

        C05471(zzaal com_google_android_gms_internal_zzaal, zzaaf com_google_android_gms_internal_zzaaf) {
    ...
    class C05482 implements OnCompleteListener<TResult> {
        final /* synthetic */ zzaal zzaBf;
        final /* synthetic */ TaskCompletionSource zzaBg;

        C05482(zzaal com_google_android_gms_internal_zzaal, TaskCompletionSource taskCompletionSource) {
            this.zzaBf = com_google_android_gms_internal_zzaal;
    ...
    void zza(zzaaf<? extends Result> com_google_android_gms_internal_zzaaf__extends_com_google_android_gms_common_api_Result, boolean z) {
        ...
        com_google_android_gms_internal_zzaaf__extends_com_google_android_gms_common_api_Result.zza(new C05471(this, com_google_android_gms_internal_zzaaf__extends_com_google_android_gms_common_api_Result));
    }
    ...
    <TResult> void zza(TaskCompletionSource<TResult> taskCompletionSource, boolean z) {
        ...
        taskCompletionSource.getTask().addOnCompleteListener(new C05482(this, taskCompletionSource));
    }
