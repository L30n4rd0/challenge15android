...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    ...
    class C06981 extends ViewPropertyAnimatorListenerAdapter {
        C06981() {
        }
    ...
    static {
        ATTRS = new int[]{C0122R.attr.actionBarSize, 16842841};
    }
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attrs) {
        ...
        this.mTopAnimatorListener = new C06981();
        this.mRemoveActionBarHideOffset = new C01292();
        this.mAddActionBarHideOffset = new C01303();
        init(context);
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0122R.id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0122R.id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0122R.id.action_bar));
        }
    }
