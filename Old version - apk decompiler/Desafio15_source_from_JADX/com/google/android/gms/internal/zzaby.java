...
public class zzaby {
    public static final Status zzaDu;
    private static final zzaaf<?>[] zzaDv;
    private final Map<zzc<?>, zze> zzaBQ;
    final Set<zzaaf<?>> zzaDw;
    private final zzb zzaDx;
    ...
    class C05591 implements zzb {
        final /* synthetic */ zzaby zzaDy;

        C05591(zzaby com_google_android_gms_internal_zzaby) {
    ...
    static {
        zzaDu = new Status(8, "The connection to Google Play services was lost");
        zzaDv = new zzaaf[0];
    }

    public zzaby(Map<zzc<?>, zze> map) {
        this.zzaDw = Collections.synchronizedSet(Collections.newSetFromMap(new WeakHashMap()));
        this.zzaDx = new C05591(this);
        this.zzaBQ = map;
    }
    ...
    private static void zza(zzaaf<?> com_google_android_gms_internal_zzaaf_, zzf com_google_android_gms_common_api_zzf, IBinder iBinder) {
        if (com_google_android_gms_internal_zzaaf_.isReady()) {
            com_google_android_gms_internal_zzaaf_.zza(new zza(com_google_android_gms_common_api_zzf, iBinder, null));
            ...
            zzb com_google_android_gms_internal_zzaby_zza = new zza(com_google_android_gms_common_api_zzf, iBinder, null);
