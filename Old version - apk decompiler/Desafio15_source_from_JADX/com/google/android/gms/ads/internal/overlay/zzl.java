...
public class zzl extends FrameLayout implements zzi {
    ...
    class C01741 implements Runnable {
        ...
        C01741(zzl com_google_android_gms_ads_internal_overlay_zzl) {
    ...
    class C01752 implements Runnable {
        ...
        C01752(zzl com_google_android_gms_ads_internal_overlay_zzl) {
            this.zzOh = com_google_android_gms_ads_internal_overlay_zzl;
        }
    ...
    private void zzie() {
        if (this.zzOe != null) {
            ...
            if (zzpk.zzkI()) {
                zzpk.m13v("Spinner frame grab took " + elapsedRealtime + "ms");
            }
    ...
    private void zzii() {
        if (this.zzIs.zzlr() != null && !this.zzNZ) {
            this.zzOa = (this.zzIs.zzlr().getWindow().getAttributes().flags & TransportMediator.FLAG_KEY_MEDIA_NEXT) != 0;
            if (!this.zzOa) {
                this.zzIs.zzlr().getWindow().addFlags(TransportMediator.FLAG_KEY_MEDIA_NEXT);
                this.zzNZ = true;
            }
        }
    }
    ...
    private void zzij() {
        if (this.zzIs.zzlr() != null && this.zzNZ && !this.zzOa) {
            this.zzIs.zzlr().getWindow().clearFlags(TransportMediator.FLAG_KEY_MEDIA_NEXT);
            this.zzNZ = false;
        }
    }
    ...
    public void zzhT() {
        this.zzNV.resume();
        zzpo.zzXC.post(new C01741(this));
    }
    ...
    public void zzhX() {
        ...
        this.zzNV.pause();
        this.zzOd = this.zzOc;
        zzpo.zzXC.post(new C01752(this));
    }
