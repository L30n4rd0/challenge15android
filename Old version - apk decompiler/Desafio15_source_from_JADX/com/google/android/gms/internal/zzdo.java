...
public class zzdo {
    ...
    class C03051 implements Runnable {
        ...
        C03051(zzdo com_google_android_gms_internal_zzdo) {
    ...
    class C05902 implements zzb {
        final /* synthetic */ zzdo zzyJ;

        C05902(zzdo com_google_android_gms_internal_zzdo) {
            this.zzyJ = com_google_android_gms_internal_zzdo;
        }
    ...
    class C05913 implements zzf.zzb {
        final /* synthetic */ zzdo zzyJ;

        C05913(zzdo com_google_android_gms_internal_zzdo) {
            this.zzyJ = com_google_android_gms_internal_zzdo;
        }
    ...
    class C05924 implements zzc {
        final /* synthetic */ zzdo zzyJ;

        C05924(zzdo com_google_android_gms_internal_zzdo) {
            this.zzyJ = com_google_android_gms_internal_zzdo;
        }
    ...
    private void connect() {
        synchronized (this.zzrJ) {
            ...
            this.zzyH = zza(new C05913(this), new C05924(this));
            this.zzyH.zzxz();
        }
    }
