...
public class zzju implements zza {
    ...
    class C03371 implements Runnable {
        ...
        C03371(zzju com_google_android_gms_internal_zzju, zzjt com_google_android_gms_internal_zzjt) {
    ...
    public zzjv zza(long j, long j2) {
        ...
        synchronized (this.zzrJ) {
            ...
            zzpo.zzXC.post(new C03371(this, com_google_android_gms_internal_zzjt));
