...
public abstract class zzf<T extends IInterface> {
    public static final String[] zzaFs;
    ...
    static {
        zzaFs = new String[]{"service_esmobile", "service_googleme"};
    }
    ...
    L_0x000b:
        ...
        r1 = r4.zzrJ;
        monitor-enter(r1);
        r4.zzaFm = r5;	 Catch:{ all -> 0x0024 }
        r4.zzaFj = r6;	 Catch:{ all -> 0x0024 }
        switch(r5) {
