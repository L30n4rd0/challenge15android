...
public class GoogleApiAvailability extends zze {
    ...
    private static final GoogleApiAvailability zzaym;
    ...
    static {
        zzaym = new GoogleApiAvailability();
    ...
    public zzaaz zza(Context context, com.google.android.gms.internal.zzaaz.zza com_google_android_gms_internal_zzaaz_zza) {
        ...
        if (zzz(context, GOOGLE_PLAY_SERVICES_PACKAGE)) {
    ...
    void zza(Context context, int i, String str, PendingIntent pendingIntent) {
        if (i == 18) {
            ...
            if (zzj.zzba(context)) {
                zzac.zzaw(zzt.zzzm());
                build = new Notification.Builder(context).setSmallIcon(context.getApplicationInfo().icon).setPriority(2).setAutoCancel(true).setContentTitle(zzh).setStyle(new BigTextStyle().bigText(zzj)).addAction(C0156R.drawable.common_full_open_on_phone, resources.getString(C0156R.string.common_open_on_phone), pendingIntent).build();
            } else {
