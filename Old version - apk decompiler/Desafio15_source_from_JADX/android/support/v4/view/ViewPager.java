...
public class ViewPager extends ViewGroup {
    ...
    static class C00801 implements Comparator<ItemInfo> {
        C00801() {
        }
    ...
    static class C00812 implements Interpolator {
        C00812() {
        }
    ...
    class C04804 implements OnApplyWindowInsetsListener {
        private final Rect mTempRect;
    ...
    public static class SavedState extends AbsSavedState {
        ...
        static class C04811 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C04811() {
            }
        ...
        static {
            CREATOR = ParcelableCompat.newCreator(new C04811());
        }
    ...
    void initViewPager() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C04804());
    }
        ...
        for (i = SCROLL_STATE_IDLE; i < size; i += SCROLL_STATE_DRAGGING) {
            ...
            if (child.getVisibility() != 8) {
                ...
                if (lp != null && lp.isDecor) {
                    ...
                    int vgrav = lp.gravity & C0453R.styleable.AppCompatTheme_spinnerStyle;
    ...
    public boolean executeKeyEvent(KeyEvent event) {
        ...
        switch (event.getKeyCode()) {
            ...
            case C0453R.styleable.AppCompatTheme_popupMenuStyle /*61*/:
                if (VERSION.SDK_INT < 11) {
                    return DEBUG;
                }
