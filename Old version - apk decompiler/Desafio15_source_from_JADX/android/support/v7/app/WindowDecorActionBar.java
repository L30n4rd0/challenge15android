...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    class C04983 implements ViewPropertyAnimatorUpdateListener {
        C04983() {
        }
    ...
    class C06951 extends ViewPropertyAnimatorListenerAdapter {
        C06951() {
        }
    ...
    class C06962 extends ViewPropertyAnimatorListenerAdapter {
        C06962() {
        }
    ...
    public WindowDecorActionBar(Activity activity, boolean overlayMode) {
        ...
        this.mHideListener = new C06951();
        this.mShowListener = new C06962();
        this.mUpdateListener = new C04983();
    ...
    private void init(View decor) {
        this.mOverlayLayout = (ActionBarOverlayLayout) decor.findViewById(C0122R.id.decor_content_parent);
        if (this.mOverlayLayout != null) {
            this.mOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(decor.findViewById(C0122R.id.action_bar));
        this.mContextView = (ActionBarContextView) decor.findViewById(C0122R.id.action_context_bar);
        this.mContainerView = (ActionBarContainer) decor.findViewById(C0122R.id.action_bar_container);
        ...
        TypedArray a = this.mContext.obtainStyledAttributes(null, C0122R.styleable.ActionBar, C0122R.attr.actionBarStyle, 0);
        if (a.getBoolean(C0122R.styleable.ActionBar_hideOnContentScroll, ALLOW_SHOW_HIDE_ANIMATIONS)) {
            setHideOnContentScrollEnabled(true);
        }
        int elevation = a.getDimensionPixelSize(C0122R.styleable.ActionBar_elevation, 0);
        if (elevation != 0) {
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0122R.attr.actionBarWidgetTheme, outValue, true);
