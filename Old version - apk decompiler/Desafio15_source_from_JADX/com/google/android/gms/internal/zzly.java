...
public class zzly {
    ...
    class C03661 implements Runnable {
        ...
        class C06691 implements zzb {
            final /* synthetic */ C03661 zzRa;
            final /* synthetic */ zzqw zztS;

            C06691(C03661 c03661, zzqw com_google_android_gms_internal_zzqw) {
                this.zzRa = c03661;
        ...
        class C06702 implements zzqx.zza {
            final /* synthetic */ C03661 zzRa;

            C06702(C03661 c03661) {
                this.zzRa = c03661;
            }
        ...
        C03661(zzly com_google_android_gms_internal_zzly, JSONObject jSONObject, zzqj com_google_android_gms_internal_zzqj) {
        ...
        public void run() {
            try {
                ...
                this.zzQZ.zzj(zzjj);
                zzjj.zzlv().zza(new C06691(this, zzjj));
                zzjj.zzlv().zza(new C06702(this));
    ...
    class C03673 implements OnGlobalLayoutListener {
        final /* synthetic */ zzly zzQZ;
        final /* synthetic */ WeakReference zzRb;

        C03673(zzly com_google_android_gms_internal_zzly, WeakReference weakReference) {
            this.zzQZ = com_google_android_gms_internal_zzly;
    ...
    class C03684 implements OnScrollChangedListener {
        final /* synthetic */ zzly zzQZ;
        final /* synthetic */ WeakReference zzRb;

        C03684(zzly com_google_android_gms_internal_zzly, WeakReference weakReference) {
            this.zzQZ = com_google_android_gms_internal_zzly;
            this.zzRb = weakReference;
        }
    ...
    class C06712 implements zzid {
        final /* synthetic */ zzly zzQZ;

        C06712(zzly com_google_android_gms_internal_zzly) {
            this.zzQZ = com_google_android_gms_internal_zzly;
        }
    ...
    private OnGlobalLayoutListener zza(WeakReference<zzqw> weakReference) {
        if (this.zzQV == null) {
            this.zzQV = new C03673(this, weakReference);
        }
        return this.zzQV;
    }
    ...
    private OnScrollChangedListener zzb(WeakReference<zzqw> weakReference) {
        if (this.zzQW == null) {
            this.zzQW = new C03684(this, weakReference);
        }
        return this.zzQW;
    }
    ...
    private void zzj(zzqw com_google_android_gms_internal_zzqw) {
        ...
        zzlv.zza("/trackActiveViewUnit", new C06712(this));
    }

    public zzqm<zzqw> zze(JSONObject jSONObject) {
        zzqm com_google_android_gms_internal_zzqj = new zzqj();
        zzw.zzcM().runOnUiThread(new C03661(this, jSONObject, com_google_android_gms_internal_zzqj));
