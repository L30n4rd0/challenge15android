...
public class FirebaseInstanceIdService extends zzb {
    ...
    @VisibleForTesting
    static final Object zzclg;
    @VisibleForTesting
    static boolean zzclh;
    private boolean zzcli;

    /* renamed from: com.google.firebase.iid.FirebaseInstanceIdService.1 */
    class C04451 extends BroadcastReceiver {
        final /* synthetic */ int zzclj;
        final /* synthetic */ FirebaseInstanceIdService zzclk;

        C04451(FirebaseInstanceIdService firebaseInstanceIdService, int i) {
            this.zzclk = firebaseInstanceIdService;
            this.zzclj = i;
        }
        ...
        public void onReceive(Context context, Intent intent) {
            if (FirebaseInstanceIdService.zzcu(context)) {
                ...
                zzg.zzabT().zzf(context, FirebaseInstanceIdService.zzqE(this.zzclj));
            }
        }
    }
    ...
    static void zza(Context context, FirebaseInstanceId firebaseInstanceId) {
        synchronized (zzclg) {
            ...
            zza zzabM = firebaseInstanceId.zzabM();
            if (zzabM == null || zzabM.zzjB(zzd.zzbhM) || firebaseInstanceId.zzabO().zzabR() != null) {
                zzct(context);
            }
        }
    }
    ...
    private void zzqF(int i) {
        ((AlarmManager) getSystemService(NotificationCompatApi24.CATEGORY_ALARM)).set(3, SystemClock.elapsedRealtime() + ((long) (i * PointerIconCompat.TYPE_DEFAULT)), zzg.zza(this, 0, zzqE(i * 2), 134217728));
    }
