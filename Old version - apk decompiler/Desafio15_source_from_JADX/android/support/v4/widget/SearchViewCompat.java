...
public final class SearchViewCompat {
    ...
    static class SearchViewCompatHoneycombImpl extends SearchViewCompatStubImpl {
        ...
        class C04891 implements OnQueryTextListenerCompatBridge {
            final /* synthetic */ OnQueryTextListener val$listener;

            C04891(OnQueryTextListener onQueryTextListener) {
        ...
        class C04902 implements OnCloseListenerCompatBridge {
            final /* synthetic */ OnCloseListener val$listener;

            C04902(OnCloseListener onCloseListener) {
        ...
        public Object newOnQueryTextListener(OnQueryTextListener listener) {
            return SearchViewCompatHoneycomb.newOnQueryTextListener(new C04891(listener));
        }
        ...
        public Object newOnCloseListener(OnCloseListener listener) {
            return SearchViewCompatHoneycomb.newOnCloseListener(new C04902(listener));
        }
