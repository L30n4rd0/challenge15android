...
public class zzatv extends zzauh {
    ...
    zzatv(zzaue com_google_android_gms_internal_zzaue) {
        ...
        this.zzbsB = new zza(this, getContext(), zzow());
    }
    ...
    L_0x0028:
        r1 = 1;
        r13.zzbsC = r1;	 Catch:{ SQLiteFullException -> 0x00a7, SQLiteException -> 0x00e9, all -> 0x011b }
    ...
    L_0x008f:
        r1 = move-exception;
        r1 = r13.zzKk();	 Catch:{ all -> 0x00a2 }
        r1 = r1.zzLX();	 Catch:{ all -> 0x00a2 }
    ...
    L_0x00a7:
        ...
        r0 = r12;
    L_0x00ab:
        r2 = r13.zzKk();	 Catch:{ all -> 0x01d3 }
        r2 = r2.zzLX();	 Catch:{ all -> 0x01d3 }
        r3 = "Error reading entries from local database";
        r2.zzj(r3, r0);	 Catch:{ all -> 0x01d3 }
        r0 = 1;
        r13.zzbsC = r0;	 Catch:{ all -> 0x01d3 }
    ...
    L_0x0103:
        r1 = move-exception;
        r1 = r13.zzKk();	 Catch:{ all -> 0x0116 }
        r1 = r1.zzLX();	 Catch:{ all -> 0x0116 }
    ...
    L_0x0148:
        r1 = move-exception;
        r1 = r13.zzKk();	 Catch:{ all -> 0x015b }
        r1 = r1.zzLX();	 Catch:{ all -> 0x015b }
        r3 = "Failed to load user property from local database";
    ...
    L_0x015b:
        ...
        throw r1;	 Catch:{ SQLiteFullException -> 0x00a7, SQLiteException -> 0x00e9, all -> 0x011b }
    L_0x0160:
        r1 = r13.zzKk();	 Catch:{ SQLiteFullException -> 0x00a7, SQLiteException -> 0x00e9, all -> 0x011b }
        r1 = r1.zzLX();	 Catch:{ SQLiteFullException -> 0x00a7, SQLiteException -> 0x00e9, all -> 0x011b }
