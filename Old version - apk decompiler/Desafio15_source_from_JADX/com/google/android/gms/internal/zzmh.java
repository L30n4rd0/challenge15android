...
public final class zzmh {
    ...
    class C06721 implements zzb {
        final /* synthetic */ Context zztf;

        C06721(Context context) {
            this.zztf = context;
        }
    ...
    public static zzpq zza(Context context, zzqh com_google_android_gms_internal_zzqh, zzqp<zzmk> com_google_android_gms_internal_zzqp_com_google_android_gms_internal_zzmk, zza com_google_android_gms_internal_zzmh_zza) {
        return zza(context, com_google_android_gms_internal_zzqh, com_google_android_gms_internal_zzqp_com_google_android_gms_internal_zzmk, com_google_android_gms_internal_zzmh_zza, new C06721(context));
    }
