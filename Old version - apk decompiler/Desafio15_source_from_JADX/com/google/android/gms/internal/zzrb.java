...
public class zzrb extends zza {
    ...
    class C04191 implements Runnable {
        ...
        C04191(zzrb com_google_android_gms_internal_zzrb, Map map) {
    ...
    class C04202 implements Runnable {
        ...
        C04202(zzrb com_google_android_gms_internal_zzrb, int i, int i2) {
            this.zzaaH = com_google_android_gms_internal_zzrb;
            this.zzaaI = i;
            this.zzaaJ = i2;
        }
    ...
    private void zzd(String str, @Nullable Map<String, String> map) {
        ...
        zzw.zzcM().runOnUiThread(new C04191(this, hashMap));
    }

    private void zzl(int i, int i2) {
        zzw.zzcM().runOnUiThread(new C04202(this, i, i2));
    }
