...
public abstract class zzc extends zzb implements zzi, zzkx {
    ...
    class C01892 implements Runnable {
        ...
        C01892(zzc com_google_android_gms_ads_internal_zzc, zza com_google_android_gms_internal_zzpb_zza) {
    ...
    class C01923 implements Runnable {
        ...
        class C01901 implements OnTouchListener {
            ...
            C01901(C01923 c01923, zzf com_google_android_gms_ads_internal_zzf) {
        ...
        class C01912 implements OnClickListener {
            ...
            C01912(C01923 c01923, zzf com_google_android_gms_ads_internal_zzf) {
                this.zzsL = com_google_android_gms_ads_internal_zzf;
            }
        ...
        C01923(zzc com_google_android_gms_ads_internal_zzc, zza com_google_android_gms_internal_zzpb_zza, zzot com_google_android_gms_internal_zzot, zzgl com_google_android_gms_internal_zzgl) {
            this.zzsH = com_google_android_gms_ads_internal_zzc;
            this.zzsI = com_google_android_gms_internal_zzpb_zza;
        ...
        public void run() {
            ...
            zza.setOnTouchListener(new C01901(this, com_google_android_gms_ads_internal_zzf));
            zza.setOnClickListener(new C01912(this, com_google_android_gms_ads_internal_zzf));
    ...
    class C05121 implements zzid {
        final /* synthetic */ zzc zzsH;

        C05121(zzc com_google_android_gms_ads_internal_zzc) {
            this.zzsH = com_google_android_gms_ads_internal_zzc;
        }
    ...
    protected void zza(zzjj com_google_android_gms_internal_zzjj) {
        com_google_android_gms_internal_zzjj.zza("/trackActiveViewUnit", new C05121(this));
    }
    ...
    protected void zza(zza com_google_android_gms_internal_zzpb_zza, zzgl com_google_android_gms_internal_zzgl) {
        if (com_google_android_gms_internal_zzpb_zza.errorCode != -2) {
            zzpo.zzXC.post(new C01892(this, com_google_android_gms_internal_zzpb_zza));
            return;
        }
        ...
        if (!com_google_android_gms_internal_zzpb_zza.zzWm.zzSn || com_google_android_gms_internal_zzpb_zza.zzWm.zzzD) {
            zzpo.zzXC.post(new C01923(this, com_google_android_gms_internal_zzpb_zza, null, com_google_android_gms_internal_zzgl));
            return;
        }
        this.zzss.zzvO = 0;
