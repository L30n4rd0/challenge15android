...
public class zzpw {
    ...
    class C04091 implements Runnable {
        ...
        C04091(zzpw com_google_android_gms_internal_zzpw) {
        ...
        public void run() {
            ...
            com.google.android.gms.internal.zzpk.m13v(r0);	 Catch:{ all -> 0x002a }
        L_0x000c:
        ...
        L_0x0014:
            ...
            com.google.android.gms.internal.zzpk.m13v(r0);	 Catch:{ InterruptedException -> 0x0023 }
            goto L_0x000c;
        L_0x0023:
            r0 = move-exception;
    ...
    public Looper zzlb() {
        ...
        synchronized (this.zzrJ) {
            if (this.zzYz != 0) {
                ...
                zzpk.m13v("Starting the looper thread.");
                this.zzYy = new HandlerThread("LooperProvider");
                this.zzYy.start();
                this.mHandler = new Handler(this.zzYy.getLooper());
                zzpk.m13v("Looper thread started.");
            } else {
                zzpk.m13v("Resuming the looper thread");
                this.zzrJ.notifyAll();
            }
            this.zzYz++;
    ...
    public void zzlc() {
        synchronized (this.zzrJ) {
            ...
            this.zzYz = i;
            if (i == 0) {
                this.mHandler.post(new C04091(this));
            }
        }
    }
}
