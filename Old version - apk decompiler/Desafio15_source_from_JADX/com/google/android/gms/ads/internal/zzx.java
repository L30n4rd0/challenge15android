...
public final class zzx implements OnGlobalLayoutListener, OnScrollChangedListener {
    ...
    public static class zza extends ViewSwitcher {
        ...
        public void zzds() {
            zzpk.m13v("Disable position monitoring on adFrame.");
            if (this.zzvY != null) {
                this.zzvY.zzlf();
            }
        }
        ...
        public void zzdx() {
            zzpk.m13v("Enable debug gesture detector on adFrame.");
            this.zzvZ = true;
        }

        public void zzdy() {
            zzpk.m13v("Disable debug gesture detector on adFrame.");
            this.zzvZ = false;
        }
    }
    ...
    public String zzdu() {
        return (this.zzvU && this.zzvV) ? BuildConfig.FLAVOR : this.zzvU ? this.zzvW ? "top-scrollable" : "top-locked" : this.zzvV ? this.zzvW ? "bottom-scrollable" : "bottom-locked" : BuildConfig.FLAVOR;
    }
