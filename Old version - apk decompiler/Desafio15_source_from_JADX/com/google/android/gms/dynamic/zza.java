...
public abstract class zza<T extends LifecycleDelegate> {
    ...
    class C02165 implements OnClickListener {
        final /* synthetic */ Intent zzaRJ;
        final /* synthetic */ Context zztf;

        C02165(Context context, Intent intent) {
            this.zztf = context;
            this.zzaRJ = intent;
        }
    ...
    class C05331 implements zze<T> {
        final /* synthetic */ zza zzaRE;

        C05331(zza com_google_android_gms_dynamic_zza) {
    ...
    class C05342 implements zza {
        final /* synthetic */ Activity val$activity;
        final /* synthetic */ zza zzaRE;
        final /* synthetic */ Bundle zzaRF;
        final /* synthetic */ Bundle zzxo;

        C05342(zza com_google_android_gms_dynamic_zza, Activity activity, Bundle bundle, Bundle bundle2) {
            this.zzaRE = com_google_android_gms_dynamic_zza;
    ...
    class C05353 implements zza {
        final /* synthetic */ zza zzaRE;
        final /* synthetic */ Bundle zzxo;

        C05353(zza com_google_android_gms_dynamic_zza, Bundle bundle) {
            this.zzaRE = com_google_android_gms_dynamic_zza;
            this.zzxo = bundle;
        }
    ...
    class C05364 implements zza {
        ...
        C05364(zza com_google_android_gms_dynamic_zza, FrameLayout frameLayout, LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
            this.zzaRE = com_google_android_gms_dynamic_zza;
    ...
    class C05376 implements zza {
        final /* synthetic */ zza zzaRE;

        C05376(zza com_google_android_gms_dynamic_zza) {
            this.zzaRE = com_google_android_gms_dynamic_zza;
        }
    ...
    class C05387 implements zza {
        final /* synthetic */ zza zzaRE;

        C05387(zza com_google_android_gms_dynamic_zza) {
            this.zzaRE = com_google_android_gms_dynamic_zza;
        }
    ...
    static void zza(FrameLayout frameLayout, GoogleApiAvailability googleApiAvailability) {
        ...
        if (zzb != null) {
            ...
            button.setOnClickListener(new C02165(context, zzb));
        }
    }
    ...
    public void onCreate(Bundle bundle) {
        zza(bundle, new C05353(this, bundle));
    }

    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        FrameLayout frameLayout = new FrameLayout(layoutInflater.getContext());
        zza(bundle, new C05364(this, frameLayout, layoutInflater, viewGroup, bundle));
        if (this.zzaRA == null) {
            zza(frameLayout);
        }
        return frameLayout;
    ...
    public void onInflate(Activity activity, Bundle bundle, Bundle bundle2) {
        zza(bundle2, new C05342(this, activity, bundle, bundle2));
    }
