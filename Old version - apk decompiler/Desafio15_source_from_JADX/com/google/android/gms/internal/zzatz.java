...
class zzatz extends BroadcastReceiver {
    ...
    class C02501 implements Runnable {
        final /* synthetic */ boolean zzbsZ;
        final /* synthetic */ zzatz zzbta;

        C02501(zzatz com_google_android_gms_internal_zzatz, boolean z) {
            this.zzbta = com_google_android_gms_internal_zzatz;
            this.zzbsZ = z;
        }

        public void run() {
            this.zzbta.zzbqg.zzW(this.zzbsZ);
        }
    }
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if ("android.net.conn.CONNECTIVITY_CHANGE".equals(action)) {
            boolean zzqa = this.zzbqg.zzMx().zzqa();
            if (this.zzagx != zzqa) {
                this.zzagx = zzqa;
                this.zzbqg.zzKj().zzm(new C02501(this, zzqa));
                return;
            }
            return;
        }
