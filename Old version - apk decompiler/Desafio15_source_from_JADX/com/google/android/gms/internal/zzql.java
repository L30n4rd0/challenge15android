...
public class zzql {
    ...
    class C04121 implements Runnable {
        ...
        C04121(zzqj com_google_android_gms_internal_zzqj, zza com_google_android_gms_internal_zzql_zza, zzqm com_google_android_gms_internal_zzqm) {
    ...
    class C04132 implements Runnable {
        final /* synthetic */ AtomicInteger zzZg;
        final /* synthetic */ int zzZh;
        final /* synthetic */ zzqj zzZi;
        final /* synthetic */ List zzZj;

        C04132(AtomicInteger atomicInteger, int i, zzqj com_google_android_gms_internal_zzqj, List list) {
    ...
    public static <A, B> zzqm<B> zza(zzqm<A> com_google_android_gms_internal_zzqm_A, zza<A, B> com_google_android_gms_internal_zzql_zza_A__B) {
        ...
        com_google_android_gms_internal_zzqm_A.zzc(new C04121(com_google_android_gms_internal_zzqj, com_google_android_gms_internal_zzql_zza_A__B, com_google_android_gms_internal_zzqm_A));
    ...
    public static <V> zzqm<List<V>> zzo(List<zzqm<V>> list) {
        ...
        for (zzqm zzc : list) {
            zzc.zzc(new C04132(atomicInteger, size, com_google_android_gms_internal_zzqj, list));
        }
        return com_google_android_gms_internal_zzqj;
    }
