...
class AccessibilityManagerCompatKitKat {
    ...
    static class C00861 implements TouchExplorationStateChangeListener {
        final /* synthetic */ TouchExplorationStateChangeListenerBridge val$bridge;

        C00861(TouchExplorationStateChangeListenerBridge touchExplorationStateChangeListenerBridge) {
