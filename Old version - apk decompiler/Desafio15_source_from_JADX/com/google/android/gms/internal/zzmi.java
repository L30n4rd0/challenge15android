...
public abstract class zzmi implements com.google.android.gms.internal.zzmh.zza, zzpq<Void> {
    ...
    class C06731 implements zzc<zzmk> {
        final /* synthetic */ zzmt zzRs;
        final /* synthetic */ zzmi zzRt;

        C06731(zzmi com_google_android_gms_internal_zzmi, zzmt com_google_android_gms_internal_zzmt) {
    ...
    class C06742 implements com.google.android.gms.internal.zzqp.zza {
        final /* synthetic */ zzmi zzRt;

        C06742(zzmi com_google_android_gms_internal_zzmi) {
            this.zzRt = com_google_android_gms_internal_zzmi;
        }
    ...
    public Void zziN() {
        ...
        if (zzjo == null) {
            ...
            this.zzRq.zza(new C06731(this, zzjo), new C06742(this));
        }
        return null;
    }
