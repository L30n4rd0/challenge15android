...
class SearchViewCompatHoneycomb {
    ...
    static class C00961 implements OnQueryTextListener {
        final /* synthetic */ OnQueryTextListenerCompatBridge val$listener;

        C00961(OnQueryTextListenerCompatBridge onQueryTextListenerCompatBridge) {
    ...
    static class C00972 implements OnCloseListener {
        final /* synthetic */ OnCloseListenerCompatBridge val$listener;

        C00972(OnCloseListenerCompatBridge onCloseListenerCompatBridge) {
