...
class ViewCompatLollipop {
    ...
    static class C00791 implements OnApplyWindowInsetsListener {
        final /* synthetic */ OnApplyWindowInsetsListenerBridge val$bridge;

        C00791(OnApplyWindowInsetsListenerBridge onApplyWindowInsetsListenerBridge) {
    ...
    public static void setOnApplyWindowInsetsListener(View view, OnApplyWindowInsetsListenerBridge bridge) {
        if (bridge == null) {
            ...
            view.setOnApplyWindowInsetsListener(new C00791(bridge));
        }
    }
