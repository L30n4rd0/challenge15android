...
public class FirebaseInstanceId {
    private static Map<String, FirebaseInstanceId> zzbhG;
    ...
    static String zza(KeyPair keyPair) {
        try {
            ...
            digest[0] = (byte) (((digest[0] & 15) + C0453R.styleable.AppCompatTheme_spinnerStyle) & MotionEventCompat.ACTION_MASK);
    ...
    @Nullable
    zza zzabM() {
        return this.zzcld.zzabP().zzu(BuildConfig.FLAVOR, this.zzcle, "*");
    }
