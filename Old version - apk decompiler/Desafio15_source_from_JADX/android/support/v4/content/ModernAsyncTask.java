...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    class C00253 extends FutureTask<Result> {
        C00253(Callable x0) {
            super(x0);
        }
    ...
    class C04612 extends WorkerRunnable<Params, Result> {
        C04612() {
        }
    ...
    public ModernAsyncTask() {
        ...
        this.mWorker = new C04612();
        this.mFuture = new C00253(this.mWorker);
    }
    ...
    public final ModernAsyncTask<Params, Progress, Result> executeOnExecutor(Executor exec, Params... params) {
        if (this.mStatus != Status.PENDING) {
            switch (C00264.$SwitchMap$android$support$v4$content$ModernAsyncTask$Status[this.mStatus.ordinal()]) {
