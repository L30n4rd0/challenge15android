...
public final class zzak extends Button {
    ...
    private void zzb(Resources resources, int i, int i2) {
        Drawable wrap = DrawableCompat.wrap(resources.getDrawable(zze(i, zzg(i2, C0156R.drawable.common_google_signin_btn_icon_dark, C0156R.drawable.common_google_signin_btn_icon_light, C0156R.drawable.common_google_signin_btn_icon_light), zzg(i2, C0156R.drawable.common_google_signin_btn_text_dark, C0156R.drawable.common_google_signin_btn_text_light, C0156R.drawable.common_google_signin_btn_text_light))));
