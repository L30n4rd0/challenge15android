...
public class zzd {
    ...
    public void zzb(String str, String str2, Bundle bundle) throws IOException {
        ...
        bundle.putString("subtype", BuildConfig.FLAVOR.equals(this.zzbhK) ? str : this.zzbhK);
        String str3 = "X-subtype";
        if (!BuildConfig.FLAVOR.equals(this.zzbhK)) {
            str = this.zzbhK;
        }
    ...
    public String zzc(String str, String str2, Bundle bundle) throws IOException {
        ...
        bundle.putString("sender", str);
        String str3 = BuildConfig.FLAVOR.equals(this.zzbhK) ? str : this.zzbhK;
