...
public abstract class zzl<T> implements Comparable<zzl<T>> {
    ...
    /* renamed from: com.google.android.gms.internal.zzl.1 */
    class C03581 implements Runnable {
        final /* synthetic */ String zzP;
        final /* synthetic */ long zzQ;
        final /* synthetic */ zzl zzR;

        C03581(zzl com_google_android_gms_internal_zzl, String str, long j) {
            this.zzR = com_google_android_gms_internal_zzl;
            this.zzP = str;
            this.zzQ = j;
        }

        public void run() {
            this.zzR.zzC.zza(this.zzP, this.zzQ);
    ...
    void zzd(String str) {
        ...
        if (zza.zzaj) {
            ...
            if (Looper.myLooper() != Looper.getMainLooper()) {
                new Handler(Looper.getMainLooper()).post(new C03581(this, str, id));
                return;
            }
            this.zzC.zza(str, id);
