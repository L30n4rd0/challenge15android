...
public class zzps {
    ...
    class C04051 implements Runnable {
        ...
        class C04041 implements OnClickListener {
            final /* synthetic */ C04051 zzYa;

            C04041(C04051 c04051) {
                this.zzYa = c04051;
            }
        ...
        C04051(zzps com_google_android_gms_internal_zzps, Context context, String str, boolean z, boolean z2) {
            this.zztf = context;
            this.zzXX = str;
            this.zzXY = z;
            this.zzXZ = z2;
        ...
        public void run() {
            ...
            if (this.zzXZ) {
                ...
                builder.setPositiveButton("Learn More", new C04041(this));
    ...
    public zzps() {
        ...
        this.zzXT = BuildConfig.FLAVOR;
        this.zzXU = BuildConfig.FLAVOR;
        this.zzXV = false;
    ...
    protected void zza(Context context, String str, boolean z, boolean z2) {
        if (context instanceof Activity) {
            zzpo.zzXC.post(new C04051(this, context, str, z, z2));
        } else {
