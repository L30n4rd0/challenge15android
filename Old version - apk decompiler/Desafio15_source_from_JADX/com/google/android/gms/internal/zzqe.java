...
public class zzqe {
    ...
    class C06881 implements zza {

        /* renamed from: com.google.android.gms.internal.zzqe.1.1 */
        class C04111 extends Thread {
            final /* synthetic */ String zzsg;

            C04111(C06881 c06881, String str) {
                this.zzsg = str;
            }
        ...
        C06881(zzqe com_google_android_gms_internal_zzqe) {
        }

        public void zzu(String str) {
            new C04111(this, str).start();
        }
    }
    ...
    public void zza(Context context, @Nullable String str, String str2, Bundle bundle, boolean z) {
        zza(context, str, str2, bundle, z, new C06881(this));
    }
