...
public class zzh {
    ...
    class C01942 implements Runnable {
        ...
        class C05161 implements zzc<zzjj> {
            final /* synthetic */ C01942 zztg;

            C05161(C01942 c01942) {
                this.zztg = c01942;
            }
        ...
        C01942(zzh com_google_android_gms_ads_internal_zzh, zzji com_google_android_gms_internal_zzji, zzid com_google_android_gms_internal_zzid, String str, String str2, boolean z, Context context) {
        ...
        public void run() {
            this.zzta.zzgO().zza(new C05161(this), new zzb());
        }
    }

    /* renamed from: com.google.android.gms.ads.internal.zzh.1 */
    class C05151 implements zzid {
        final /* synthetic */ Runnable zzsY;
        final /* synthetic */ zzh zzsZ;

        C05151(zzh com_google_android_gms_ads_internal_zzh, Runnable runnable) {
    ...
    void zza(Context context, zzqh com_google_android_gms_internal_zzqh, boolean z, @Nullable zzpd com_google_android_gms_internal_zzpd, String str, @Nullable String str2, @Nullable Runnable runnable) {
        ...
        if (context == null) {
            ...
            zzpo.zzXC.post(new C01942(this, zzw.zzcM().zzd(context, com_google_android_gms_internal_zzqh), new C05151(this, runnable), str, str2, z, context));
        }
    }
}
