...
public abstract class zzl<T extends IInterface> extends zzf<T> implements zze, zza {
    ...
    class C05311 implements zzb {
        final /* synthetic */ ConnectionCallbacks zzaFS;

        C05311(ConnectionCallbacks connectionCallbacks) {
    ...
    class C05322 implements zzc {
        final /* synthetic */ OnConnectionFailedListener zzaFT;

        C05322(OnConnectionFailedListener onConnectionFailedListener) {
    ...
    private static zzb zza(ConnectionCallbacks connectionCallbacks) {
        return connectionCallbacks == null ? null : new C05311(connectionCallbacks);
    }

    @Nullable
    private static zzc zza(OnConnectionFailedListener onConnectionFailedListener) {
        return onConnectionFailedListener == null ? null : new C05322(onConnectionFailedListener);
    }
