...
final class BackStackRecord extends FragmentTransaction implements BackStackEntry, Runnable {
    ...
    class C00122 implements OnPreDrawListener {
        ...
        C00122(View view, Object obj, ArrayList arrayList, TransitionState transitionState, Object obj2, Object obj3, boolean z, Fragment fragment, Fragment fragment2) {
    ...
    class C00133 implements OnPreDrawListener {
        final /* synthetic */ int val$containerId;
        final /* synthetic */ View val$sceneRoot;
        final /* synthetic */ TransitionState val$state;
        final /* synthetic */ Object val$transition;

        C00133(View view, TransitionState transitionState, int i, Object obj) {
            this.val$sceneRoot = view;
            this.val$state = transitionState;
    ...
    class C04561 implements ViewRetriever {
        final /* synthetic */ Fragment val$inFragment;

        C04561(Fragment fragment) {
            this.val$inFragment = fragment;
        }
    ...
    private boolean configureTransitions(int containerId, TransitionState state, boolean isBack, SparseArray<Fragment> firstOutFragments, SparseArray<Fragment> lastInFragments) {
        ...
        ViewRetriever c04561 = new C04561(inFragment);
        ...
        if (transition != null) {
            FragmentTransitionCompat21.addTransitionTargets(enterTransition, sharedElementTransition, exitTransition, sceneRoot, c04561, state.nonExistentView, state.enteringEpicenterView, state.nameOverrides, enteringViews, exitingViews, namedViews, renamedViews, sharedElementTargets);
    ...
    private void prepareSharedElementTransition(TransitionState state, View sceneRoot, Object sharedElementTransition, Fragment inFragment, Fragment outFragment, boolean isBack, ArrayList<View> sharedElementTargets, Object enterTransition, Object exitTransition) {
        if (sharedElementTransition != null) {
            sceneRoot.getViewTreeObserver().addOnPreDrawListener(new C00122(sceneRoot, sharedElementTransition, sharedElementTargets, state, enterTransition, exitTransition, isBack, inFragment, outFragment));
        }
    }
    ...
    private void excludeHiddenFragmentsAfterEnter(View sceneRoot, TransitionState state, int containerId, Object transition) {
        sceneRoot.getViewTreeObserver().addOnPreDrawListener(new C00133(sceneRoot, state, containerId, transition));
    }
