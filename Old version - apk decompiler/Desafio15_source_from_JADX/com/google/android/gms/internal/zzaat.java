...
public final class zzaat extends GoogleApiClient implements com.google.android.gms.internal.zzabc.zza {
    ...
    final Queue<com.google.android.gms.internal.zzaad.zza<?, ?>> zzaAU;
    ...
    Set<Scope> zzaBR;
    private final zzabi zzaBS;
    private final ArrayList<zzaag> zzaBT;
    private Integer zzaBU;
    Set<zzabx> zzaBV;
    final zzaby zzaBW;
    private final com.google.android.gms.common.internal.zzm.zza zzaBX;
    ...
    class C05541 implements com.google.android.gms.common.internal.zzm.zza {
        final /* synthetic */ zzaat zzaBY;

        C05541(zzaat com_google_android_gms_internal_zzaat) {
            this.zzaBY = com_google_android_gms_internal_zzaat;
        }
    ...
    /* renamed from: com.google.android.gms.internal.zzaat.2 */
    class C05552 implements ConnectionCallbacks {
        final /* synthetic */ zzaat zzaBY;
        final /* synthetic */ AtomicReference zzaBZ;
        final /* synthetic */ zzabt zzaCa;

        C05552(zzaat com_google_android_gms_internal_zzaat, AtomicReference atomicReference, zzabt com_google_android_gms_internal_zzabt) {
            this.zzaBY = com_google_android_gms_internal_zzaat;
            this.zzaBZ = atomicReference;
            this.zzaCa = com_google_android_gms_internal_zzabt;
        }

        public void onConnected(Bundle bundle) {
            this.zzaBY.zza((GoogleApiClient) this.zzaBZ.get(), this.zzaCa, true);
        }
    ...
    /* renamed from: com.google.android.gms.internal.zzaat.3 */
    class C05563 implements OnConnectionFailedListener {
        final /* synthetic */ zzabt zzaCa;

        C05563(zzaat com_google_android_gms_internal_zzaat, zzabt com_google_android_gms_internal_zzabt) {
            this.zzaCa = com_google_android_gms_internal_zzabt;
        }

        public void onConnectionFailed(@NonNull ConnectionResult connectionResult) {
            this.zzaCa.zzb(new Status(8));
        }
    }

    /* renamed from: com.google.android.gms.internal.zzaat.4 */
    class C05574 implements ResultCallback<Status> {
        final /* synthetic */ zzaat zzaBY;
        final /* synthetic */ zzabt zzaCa;
        final /* synthetic */ boolean zzaCb;
        final /* synthetic */ GoogleApiClient zzapg;

        C05574(zzaat com_google_android_gms_internal_zzaat, zzabt com_google_android_gms_internal_zzabt, boolean z, GoogleApiClient googleApiClient) {
            this.zzaBY = com_google_android_gms_internal_zzaat;
            this.zzaCa = com_google_android_gms_internal_zzabt;
            this.zzaCb = z;
            this.zzapg = googleApiClient;
        }
    ...
    public zzaat(Context context, Lock lock, Looper looper, zzg com_google_android_gms_common_internal_zzg, GoogleApiAvailability googleApiAvailability, com.google.android.gms.common.api.Api.zza<? extends zzbai, zzbaj> com_google_android_gms_common_api_Api_zza__extends_com_google_android_gms_internal_zzbai__com_google_android_gms_internal_zzbaj, Map<Api<?>, Boolean> map, List<ConnectionCallbacks> list, List<OnConnectionFailedListener> list2, Map<zzc<?>, zze> map2, int i, int i2, ArrayList<zzaag> arrayList, boolean z) {
        this.zzaBK = null;
        this.zzaAU = new LinkedList();
        this.zzaBM = 120000;
        this.zzaBN = 5000;
        this.zzaBR = new HashSet();
        this.zzaBS = new zzabi();
        this.zzaBU = null;
        this.zzaBV = null;
        this.zzaBX = new C05541(this);
    ...
    private void zza(GoogleApiClient googleApiClient, zzabt com_google_android_gms_internal_zzabt, boolean z) {
        zzacf.zzaGM.zzg(googleApiClient).setResultCallback(new C05574(this, com_google_android_gms_internal_zzabt, z, googleApiClient));
    }
    ...
    public PendingResult<Status> clearDefaultAccountAndReconnect() {
        ...
        PendingResult com_google_android_gms_internal_zzabt = new zzabt((GoogleApiClient) this);
        if (this.zzaBQ.containsKey(zzacf.zzaid)) {
            zza(this, com_google_android_gms_internal_zzabt, false);
        } else {
            AtomicReference atomicReference = new AtomicReference();
            GoogleApiClient build = new Builder(this.mContext).addApi(zzacf.API).addConnectionCallbacks(new C05552(this, atomicReference, com_google_android_gms_internal_zzabt)).addOnConnectionFailedListener(new C05563(this, com_google_android_gms_internal_zzabt)).setHandler(this.zzaBO).build();
