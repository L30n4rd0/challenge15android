...
public class zzt {
    ...
    class C02031 implements Runnable {
        ...
        C02031(zzt com_google_android_gms_ads_internal_zzt, WeakReference weakReference) {
    ...
    zzt(zza com_google_android_gms_ads_internal_zza, zza com_google_android_gms_ads_internal_zzt_zza) {
        ...
        this.zzw = new C02031(this, new WeakReference(com_google_android_gms_ads_internal_zza));
    }
