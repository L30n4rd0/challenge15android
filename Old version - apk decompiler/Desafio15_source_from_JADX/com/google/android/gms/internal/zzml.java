        ...
        while (parcel.dataPosition() < zzaY) {
            ...
            switch (zzb.zzdc(zzaX)) {
                ...
                case ConnectionResult.RESTRICTED_PROFILE /*20*/:
                    ...
                    break;
                case C0453R.styleable.Toolbar_buttonGravity /*21*/:
                ...
                case C0453R.styleable.Toolbar_logoDescription /*26*/:
                    ...
                    break;
                case C0453R.styleable.Toolbar_titleTextColor /*27*/:
                    list2 = zzb.zzE(parcel, zzaX);
                    break;
                case C0453R.styleable.Toolbar_subtitleTextColor /*28*/:
                    str7 = zzb.zzq(parcel, zzaX);
                    break;
                case C0453R.styleable.AppCompatTheme_actionModeBackground /*29*/:
                    com_google_android_gms_internal_zzhc = (zzhc) zzb.zza(parcel, zzaX, zzhc.CREATOR);
                    break;
                case C0453R.styleable.AppCompatTheme_actionModeSplitBackground /*30*/:
                    list3 = zzb.zzE(parcel, zzaX);
                    break;
                case C0453R.styleable.AppCompatTheme_actionModeCloseDrawable /*31*/:
                ...
                case TransportMediator.FLAG_KEY_MEDIA_STOP /*32*/:
                    ...
                    break;
                case C0453R.styleable.AppCompatTheme_actionModeCopyDrawable /*33*/:
                    str8 = zzb.zzq(parcel, zzaX);
                    break;
                case C0453R.styleable.AppCompatTheme_actionModePasteDrawable /*34*/:
                    f2 = zzb.zzl(parcel, zzaX);
                    break;
                case C0453R.styleable.AppCompatTheme_actionModeSelectAllDrawable /*35*/:
                    i5 = zzb.zzg(parcel, zzaX);
                    break;
                case C0453R.styleable.AppCompatTheme_actionModeShareDrawable /*36*/:
                    i6 = zzb.zzg(parcel, zzaX);
                    break;
                case C0453R.styleable.AppCompatTheme_actionModeFindDrawable /*37*/:
                    z3 = zzb.zzc(parcel, zzaX);
                    break;
                case C0453R.styleable.AppCompatTheme_actionModeWebSearchDrawable /*38*/:
                    z4 = zzb.zzc(parcel, zzaX);
                    break;
                case C0453R.styleable.AppCompatTheme_actionModePopupWindowStyle /*39*/:
                    str9 = zzb.zzq(parcel, zzaX);
                    break;
                case C0453R.styleable.AppCompatTheme_textAppearanceLargePopupMenu /*40*/:
                    z2 = zzb.zzc(parcel, zzaX);
                    break;
                case C0453R.styleable.AppCompatTheme_textAppearanceSmallPopupMenu /*41*/:
                    str10 = zzb.zzq(parcel, zzaX);
                    break;
                case C0453R.styleable.AppCompatTheme_textAppearancePopupMenuHeader /*42*/:
                    z5 = zzb.zzc(parcel, zzaX);
                    break;
                case C0453R.styleable.AppCompatTheme_dialogTheme /*43*/:
                    i7 = zzb.zzg(parcel, zzaX);
                    break;
                case C0453R.styleable.AppCompatTheme_dialogPreferredPadding /*44*/:
                    bundle4 = zzb.zzs(parcel, zzaX);
                    break;
                case C0453R.styleable.AppCompatTheme_listDividerAlertDialog /*45*/:
                    str11 = zzb.zzq(parcel, zzaX);
                    break;
                case C0453R.styleable.AppCompatTheme_actionDropDownStyle /*46*/:
                    com_google_android_gms_internal_zzfc = (zzfc) zzb.zza(parcel, zzaX, zzfc.CREATOR);
                    break;
                case C0453R.styleable.AppCompatTheme_dropdownListPreferredItemHeight /*47*/:
                    z6 = zzb.zzc(parcel, zzaX);
                    break;
                case C0453R.styleable.AppCompatTheme_spinnerDropDownItemStyle /*48*/:
                    bundle5 = zzb.zzs(parcel, zzaX);
                    break;
                case C0453R.styleable.AppCompatTheme_homeAsUpIndicator /*49*/:
                    str12 = zzb.zzq(parcel, zzaX);
                    break;
                case C0453R.styleable.AppCompatTheme_actionButtonStyle /*50*/:
                    str13 = zzb.zzq(parcel, zzaX);
                    break;
                case C0453R.styleable.AppCompatTheme_buttonBarStyle /*51*/:
                    str14 = zzb.zzq(parcel, zzaX);
                    break;
                case C0453R.styleable.AppCompatTheme_buttonBarButtonStyle /*52*/:
