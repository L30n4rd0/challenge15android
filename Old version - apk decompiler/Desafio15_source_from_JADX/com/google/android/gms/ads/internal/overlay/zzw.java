...
public class zzw {
    ...
    class C01761 implements Runnable {
        ...
        C01761(zzw com_google_android_gms_ads_internal_overlay_zzw, zzi com_google_android_gms_ads_internal_overlay_zzi) {
    ...
    public void zza(SurfaceTexture surfaceTexture, zzi com_google_android_gms_ads_internal_overlay_zzi) {
        if (com_google_android_gms_ads_internal_overlay_zzi != null) {
            ...
            if (this.zzOm || Math.abs(timestamp - this.zzOl) >= this.zzOk) {
                this.zzOm = false;
                this.zzOl = timestamp;
                zzpo.zzXC.post(new C01761(this, com_google_android_gms_ads_internal_overlay_zzi));
            }
        }
    }
