...
public class zzf {
    ...
    int zzbig;
    long zzbih;
    private final SimpleArrayMap<String, zzb> zzclo;
    Context zzqn;
    ...
    class C04491 extends Handler {
        ...
        C04491(zzf com_google_firebase_iid_zzf, Looper looper) {
            this.zzclp = com_google_firebase_iid_zzf;
            super(looper);
        }
    ...
    private void zzeF(String str) {
        if ("com.google.android.gsf".equals(zzbhW)) {
            ...
            if (this.zzbif >= 3) {
                if (this.zzbif == 3) {
                    this.zzbig = new Random().nextInt(PointerIconCompat.TYPE_DEFAULT) + PointerIconCompat.TYPE_DEFAULT;
                }
                this.zzbig *= 2;
    ...
    void zzHl() {
        if (this.zzbgJ == null) {
            zzbA(this.zzqn);
            this.zzbgJ = new Messenger(new C04491(this, Looper.getMainLooper()));
        }
    }
    ...
    void zzu(Intent intent) {
        ...
        if (longExtra > 0) {
            ...
            this.zzbig = ((int) longExtra) * PointerIconCompat.TYPE_DEFAULT;
            this.zzbih = SystemClock.elapsedRealtime() + ((long) this.zzbig);
